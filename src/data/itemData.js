import { getLocaleText } from "../localization/index.js?v=421";
import { LOOT_ITEM_BALANCE_DATA } from "../balance/itemBalanceData.js?v=421";
import { equipment } from "./equipmentData.js?v=421";
