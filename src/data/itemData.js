import { getLocaleText } from "../localization/index.js?v=407";
import { LOOT_ITEM_BALANCE_DATA } from "../balance/itemBalanceData.js?v=407";
import { equipment } from "./equipmentData.js?v=407";
