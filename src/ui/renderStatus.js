import { RESISTANCE_STATS } from "../state/resistanceCatalog.js?v=505";
import { allocatedFreeStatPoints } from "../state/statAllocation.js?v=505";
import { statusGradeFromStats } from "../state/statusGrade.js?v=505";
import { t, tf } from "../localization/index.js?v=505";
import { renderPortraitImagePreview } from "./portraitFrameView.js?v=505";
