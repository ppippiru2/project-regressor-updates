import { RESISTANCE_STATS } from "../state/resistanceCatalog.js?v=417";
import { allocatedFreeStatPoints } from "../state/statAllocation.js?v=417";
import { statusGradeFromStats } from "../state/statusGrade.js?v=417";
import { t, tf } from "../localization/index.js?v=417";
import { renderPortraitImagePreview } from "./portraitFrameView.js?v=417";
