import { RESISTANCE_STATS } from "../state/resistanceCatalog.js?v=511";
import { allocatedFreeStatPoints } from "../state/statAllocation.js?v=511";
import { statusGradeFromStats } from "../state/statusGrade.js?v=511";
import { t, tf } from "../localization/index.js?v=511";
import { renderPortraitImagePreview } from "./portraitFrameView.js?v=511";
