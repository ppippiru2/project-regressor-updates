import { RESISTANCE_STATS } from "../state/resistanceCatalog.js?v=346";
import { allocatedFreeStatPoints } from "../state/statAllocation.js?v=346";
import { t, tf } from "../localization/index.js?v=346";
import { renderPortraitImagePreview } from "./portraitFrameView.js?v=346";
