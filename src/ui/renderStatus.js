import { RESISTANCE_STATS } from "../state/resistanceCatalog.js?v=501";
import { allocatedFreeStatPoints } from "../state/statAllocation.js?v=501";
import { statusGradeFromStats } from "../state/statusGrade.js?v=501";
import { t, tf } from "../localization/index.js?v=501";
import { renderPortraitImagePreview } from "./portraitFrameView.js?v=501";
