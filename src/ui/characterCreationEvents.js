import { getLocaleText, tf } from "../localization/index.js?v=473";
import { resolveAlignment } from "../state/profile.js?v=473";
import {
...
import {
  ...
  renderDiceSprite,
} from "./diceSpriteRenderer.js?v=473";
import { INITIAL_CREATION_STAT_BALANCE } from "../balance/playerGrowthBalance.js?v=473";
import { statusGradeFromStats } from "../state/statusGrade.js?v=473";
