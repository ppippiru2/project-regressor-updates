import { getLocaleText, tf } from "../localization/index.js?v=472";
import { resolveAlignment } from "../state/profile.js?v=472";
import {
...
import {
  ...
  renderDiceSprite,
} from "./diceSpriteRenderer.js?v=472";
import { INITIAL_CREATION_STAT_BALANCE } from "../balance/playerGrowthBalance.js?v=472";
import { statusGradeFromStats } from "../state/statusGrade.js?v=472";
