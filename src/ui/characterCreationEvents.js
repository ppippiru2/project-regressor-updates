...
import {
  ...
  renderDiceSprite,
} from "./diceSpriteRenderer.js?v=392";
import { INITIAL_CREATION_STAT_BALANCE } from "../balance/playerGrowthBalance.js?v=392";
