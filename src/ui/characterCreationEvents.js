...
import {
  ...
  renderDiceSprite,
} from "./diceSpriteRenderer.js?v=384";
import { INITIAL_CREATION_STAT_BALANCE } from "../balance/playerGrowthBalance.js?v=384";
