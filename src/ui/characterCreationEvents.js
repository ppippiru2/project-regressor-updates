...
import {
  ...
  renderDiceSprite,
} from "./diceSpriteRenderer.js?v=386";
import { INITIAL_CREATION_STAT_BALANCE } from "../balance/playerGrowthBalance.js?v=386";
