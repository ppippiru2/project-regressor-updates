import { getLocaleText, tf } from "../localization/index.js?v=468";
import { resolveAlignment } from "../state/profile.js?v=468";
import {
  DEFAULT_PORTRAIT_FRAME,
  dragPortraitFrame,
  nudgePortraitFrame,
  normalizePortraitFrame,
} from "../state/portraitFrame.js?v=468";
import {
  applyPortraitFrameToElement,
  portraitCropImageHtml,
  portraitFrameInlineStyle,
} from "./portraitFrameView.js?v=468";
import {
  diceFaceFromStats,
  diceRollDuration,
  initialDiceFace,
  ...
  renderDiceSprite,
} from "./diceSpriteRenderer.js?v=468";
import { INITIAL_CREATION_STAT_BALANCE } from "../balance/playerGrowthBalance.js?v=468";
import { statusGradeFromStats } from "../state/statusGrade.js?v=468";
