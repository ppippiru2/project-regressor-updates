...
import {
  ...
  renderDiceSprite,
} from "./diceSpriteRenderer.js?v=429";
import { INITIAL_CREATION_STAT_BALANCE } from "../balance/playerGrowthBalance.js?v=429";
import { statusGradeFromStats } from "../state/statusGrade.js?v=429";
