...
import {
  ...
  renderDiceSprite,
} from "./diceSpriteRenderer.js?v=393";
import { INITIAL_CREATION_STAT_BALANCE } from "../balance/playerGrowthBalance.js?v=393";
