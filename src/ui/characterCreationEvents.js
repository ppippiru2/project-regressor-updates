import { getLocaleText, tf } from "../localization/index.js?v=464";
import { resolveAlignment } from "../state/profile.js?v=464";
import {
  DEFAULT_PORTRAIT_FRAME,
  dragPortraitFrame,
  nudgePortraitFrame,
  normalizePortraitFrame,
} from "../state/portraitFrame.js?v=464";
import {
  applyPortraitFrameToElement,
  portraitCropImageHtml,
  portraitFrameInlineStyle,
} from "./portraitFrameView.js?v=464";
import {
  diceFaceFromStats,
  diceRollDuration,
  initialDiceFace,
  ...
  renderDiceSprite,
} from "./diceSpriteRenderer.js?v=464";
import { INITIAL_CREATION_STAT_BALANCE } from "../balance/playerGrowthBalance.js?v=464";
import { statusGradeFromStats } from "../state/statusGrade.js?v=464";
