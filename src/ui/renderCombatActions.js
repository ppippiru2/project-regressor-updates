import { weaknessAutoHuntSkillScore } from "../combat/combatActions.js?v=531";
import { calculateWeaknessSkillDamageMultiplier } from "../combat/combatHitResults.js?v=531";
