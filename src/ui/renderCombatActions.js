import { weaknessAutoHuntSkillScore } from "../combat/combatActions.js?v=524";
import { calculateWeaknessSkillDamageMultiplier } from "../combat/combatHitResults.js?v=524";
