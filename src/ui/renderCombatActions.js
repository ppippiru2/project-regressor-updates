import { weaknessAutoHuntSkillScore } from "../combat/combatActions.js?v=530";
import { calculateWeaknessSkillDamageMultiplier } from "../combat/combatHitResults.js?v=530";
