import { weaknessAutoHuntSkillScore } from "../combat/combatActions.js?v=529";
import { calculateWeaknessSkillDamageMultiplier } from "../combat/combatHitResults.js?v=529";
