import { weaknessAutoHuntSkillScore } from "../combat/combatActions.js?v=520";
import { calculateWeaknessSkillDamageMultiplier } from "../combat/combatHitResults.js?v=520";
