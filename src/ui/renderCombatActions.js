import { weaknessAutoHuntSkillScore } from "../combat/combatActions.js?v=518";
import { calculateWeaknessSkillDamageMultiplier } from "../combat/combatHitResults.js?v=518";
