import { weaknessAutoHuntSkillScore } from "../combat/combatActions.js?v=514";
import { calculateWeaknessSkillDamageMultiplier } from "../combat/combatHitResults.js?v=514";
