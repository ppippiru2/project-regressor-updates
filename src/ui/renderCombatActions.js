import { weaknessAutoHuntSkillScore } from "../combat/combatActions.js?v=528";
import { calculateWeaknessSkillDamageMultiplier } from "../combat/combatHitResults.js?v=528";
