import { weaknessAutoHuntSkillScore } from "../combat/combatActions.js?v=517";
import { calculateWeaknessSkillDamageMultiplier } from "../combat/combatHitResults.js?v=517";
