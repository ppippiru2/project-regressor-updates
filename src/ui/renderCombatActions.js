import { weaknessAutoHuntSkillScore } from "../combat/combatActions.js?v=521";
import { calculateWeaknessSkillDamageMultiplier } from "../combat/combatHitResults.js?v=521";
