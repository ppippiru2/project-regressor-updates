import { t } from "../localization/index.js?v=427";
import { resolveRegionCoreEvent } from "../story/coreEventCatalog.js?v=427";
import { resolveTutorialKeyEventDialogue } from "../story/tutorialDialogueEvents.js?v=427";
