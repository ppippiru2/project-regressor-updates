import { t } from "../localization/index.js?v=434";
import { resolveRegionCoreEvent } from "../story/coreEventCatalog.js?v=434";
import { resolveTutorialKeyEventDialogue } from "../story/tutorialDialogueEvents.js?v=434";
