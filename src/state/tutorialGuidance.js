import { t } from "../localization/index.js?v=420";
import { resolveRegionCoreEvent } from "../story/coreEventCatalog.js?v=420";
import { resolveTutorialKeyEventDialogue } from "../story/tutorialDialogueEvents.js?v=420";
