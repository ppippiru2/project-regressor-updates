import { t } from "../localization/index.js?v=422";
import { resolveRegionCoreEvent } from "../story/coreEventCatalog.js?v=422";
import { resolveTutorialKeyEventDialogue } from "../story/tutorialDialogueEvents.js?v=422";
