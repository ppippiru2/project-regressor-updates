import { getLocaleText, t } from "../localization/index.js?v=681";
import { REGRESSION_FATE_CARD_POOL_DATA } from "../data/fateCardPoolData.js?v=681";
import { resolveFateCardVisual, resolveFateCardVisualSlug } from "../data/fateCardVisualData.js?v=681";
import { resolveFateCardAuraTier } from "./fateCardRoller.js?v=681";
