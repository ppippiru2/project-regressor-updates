import { getLocaleText, t } from "../localization/index.js?v=680";
import { REGRESSION_FATE_CARD_POOL_DATA } from "../data/fateCardPoolData.js?v=680";
import { resolveFateCardVisual, resolveFateCardVisualSlug } from "../data/fateCardVisualData.js?v=680";
import { resolveFateCardAuraTier } from "./fateCardRoller.js?v=680";
