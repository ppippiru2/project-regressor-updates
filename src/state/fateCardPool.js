import { getLocaleText, t } from "../localization/index.js?v=679";
import { REGRESSION_FATE_CARD_POOL_DATA } from "../data/fateCardPoolData.js?v=679";
import { resolveFateCardVisual, resolveFateCardVisualSlug } from "../data/fateCardVisualData.js?v=679";
import { resolveFateCardAuraTier } from "./fateCardRoller.js?v=679";
