...
const MIN_FRAME_POSITION = 0;
const MAX_FRAME_POSITION = 100;
...
export function normalizePortraitFrame(frame = {}) {
  ...
  return {
    x: roundFrameNumber(clampNumber(Number(source.x), MIN_FRAME_POSITION, MAX_FRAME_POSITION, DEFAULT_PORTRAIT_FRAME.x)),
    y: roundFrameNumber(clampNumber(Number(source.y), MIN_FRAME_POSITION, MAX_FRAME_POSITION, DEFAULT_PORTRAIT_FRAME.y)),
    scale: roundFrameNumber(clampNumber(Number(source.scale), MIN_FRAME_SCALE, MAX_FRAME_SCALE, DEFAULT_PORTRAIT_FRAME.scale)),
  };
}
