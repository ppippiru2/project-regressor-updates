...
import { droppedEquipmentInsight } from "./lootInsight.js?v=414";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=414";
