...
import { droppedEquipmentInsight } from "./lootInsight.js?v=344";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=344";
