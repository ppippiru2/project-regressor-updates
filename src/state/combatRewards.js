...
import { droppedEquipmentInsight } from "./lootInsight.js?v=403";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=403";
