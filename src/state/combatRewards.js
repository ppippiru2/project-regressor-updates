...
import { droppedEquipmentInsight } from "./lootInsight.js?v=338";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=338";
