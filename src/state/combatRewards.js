...
import { droppedEquipmentInsight } from "./lootInsight.js?v=392";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=392";
