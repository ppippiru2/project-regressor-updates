...
import { droppedEquipmentInsight } from "./lootInsight.js?v=346";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=346";
