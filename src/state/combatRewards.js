...
import { droppedEquipmentInsight } from "./lootInsight.js?v=348";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=348";
