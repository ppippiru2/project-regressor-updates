...
import { droppedEquipmentInsight } from "./lootInsight.js?v=371";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=371";
