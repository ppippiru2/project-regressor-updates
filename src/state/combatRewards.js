...
import { droppedEquipmentInsight } from "./lootInsight.js?v=402";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=402";
