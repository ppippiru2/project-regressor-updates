...
import { droppedEquipmentInsight } from "./lootInsight.js?v=411";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=411";
