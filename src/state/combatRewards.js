...
import { droppedEquipmentInsight } from "./lootInsight.js?v=405";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=405";
