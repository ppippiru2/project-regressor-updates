...
import { droppedEquipmentInsight } from "./lootInsight.js?v=381";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=381";
