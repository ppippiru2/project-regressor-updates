...
import { droppedEquipmentInsight } from "./lootInsight.js?v=368";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=368";
