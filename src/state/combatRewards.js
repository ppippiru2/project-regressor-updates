...
import { droppedEquipmentInsight } from "./lootInsight.js?v=517";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=517";
import { claimFirstCodexRecordGuide, claimFirstLootDropGuide } from "./tutorialGuidance.js?v=517";
import { t, tf } from "../localization/index.js?v=517";
import { resolveRegionCoreEvent } from "../story/coreEventCatalog.js?v=517";
