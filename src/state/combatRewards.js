...
import { droppedEquipmentInsight } from "./lootInsight.js?v=511";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=511";
import { claimFirstCodexRecordGuide, claimFirstLootDropGuide } from "./tutorialGuidance.js?v=511";
import { t, tf } from "../localization/index.js?v=511";
import { resolveRegionCoreEvent } from "../story/coreEventCatalog.js?v=511";
