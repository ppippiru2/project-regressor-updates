...
import { droppedEquipmentInsight } from "./lootInsight.js?v=398";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=398";
