...
import { droppedEquipmentInsight } from "./lootInsight.js?v=342";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=342";
