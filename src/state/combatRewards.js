...
import { droppedEquipmentInsight } from "./lootInsight.js?v=323";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=323";
