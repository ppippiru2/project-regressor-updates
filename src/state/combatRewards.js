...
import { droppedEquipmentInsight } from "./lootInsight.js?v=387";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=387";
