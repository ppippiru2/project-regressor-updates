...
import { droppedEquipmentInsight } from "./lootInsight.js?v=385";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=385";
