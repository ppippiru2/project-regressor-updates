...
import { droppedEquipmentInsight } from "./lootInsight.js?v=401";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=401";
