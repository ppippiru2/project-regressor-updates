...
import { droppedEquipmentInsight } from "./lootInsight.js?v=378";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=378";
