...
import { droppedEquipmentInsight } from "./lootInsight.js?v=531";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=531";
import { claimFirstCodexRecordGuide, claimFirstLootDropGuide } from "./tutorialGuidance.js?v=531";
import { t, tf } from "../localization/index.js?v=531";
import { resolveRegionCoreEvent } from "../story/coreEventCatalog.js?v=531";
