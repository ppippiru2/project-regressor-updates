...
import { droppedEquipmentInsight } from "./lootInsight.js?v=383";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=383";
