...
import { droppedEquipmentInsight } from "./lootInsight.js?v=388";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=388";
