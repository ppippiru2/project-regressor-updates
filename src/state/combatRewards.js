...
import { droppedEquipmentInsight } from "./lootInsight.js?v=417";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=417";
