...
import { droppedEquipmentInsight } from "./lootInsight.js?v=358";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=358";
