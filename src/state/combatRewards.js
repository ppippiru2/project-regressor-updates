...
import { droppedEquipmentInsight } from "./lootInsight.js?v=390";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=390";
