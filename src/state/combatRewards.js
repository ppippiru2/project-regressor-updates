...
import { droppedEquipmentInsight } from "./lootInsight.js?v=339";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=339";
