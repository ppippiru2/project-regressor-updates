...
import { droppedEquipmentInsight } from "./lootInsight.js?v=445";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=445";
import { claimFirstCodexRecordGuide } from "./tutorialGuidance.js?v=445";
import { t, tf } from "../localization/index.js?v=445";
import { resolveRegionCoreEvent } from "../story/coreEventCatalog.js?v=445";
