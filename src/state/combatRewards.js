...
import { droppedEquipmentInsight } from "./lootInsight.js?v=416";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=416";
