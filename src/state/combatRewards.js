...
import { droppedEquipmentInsight } from "./lootInsight.js?v=406";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=406";
