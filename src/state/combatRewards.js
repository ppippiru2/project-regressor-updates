...
import { droppedEquipmentInsight } from "./lootInsight.js?v=365";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=365";
