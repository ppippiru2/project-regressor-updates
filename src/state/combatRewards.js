...
import { droppedEquipmentInsight } from "./lootInsight.js?v=366";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=366";
