...
import { droppedEquipmentInsight } from "./lootInsight.js?v=389";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=389";
