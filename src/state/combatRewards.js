...
import { droppedEquipmentInsight } from "./lootInsight.js?v=397";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=397";
