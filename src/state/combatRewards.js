...
import { droppedEquipmentInsight } from "./lootInsight.js?v=343";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=343";
