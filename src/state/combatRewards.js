...
import { droppedEquipmentInsight } from "./lootInsight.js?v=354";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=354";
