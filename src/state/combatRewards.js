...
import { droppedEquipmentInsight } from "./lootInsight.js?v=413";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=413";
