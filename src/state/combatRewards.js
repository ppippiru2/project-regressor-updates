...
import { droppedEquipmentInsight } from "./lootInsight.js?v=490";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=490";
import { claimFirstCodexRecordGuide, claimFirstLootDropGuide } from "./tutorialGuidance.js?v=490";
import { t, tf } from "../localization/index.js?v=490";
import { resolveRegionCoreEvent } from "../story/coreEventCatalog.js?v=490";
