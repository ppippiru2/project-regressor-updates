...
import { droppedEquipmentInsight } from "./lootInsight.js?v=351";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=351";
