...
import { droppedEquipmentInsight } from "./lootInsight.js?v=361";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=361";
