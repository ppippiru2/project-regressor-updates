...
import { droppedEquipmentInsight } from "./lootInsight.js?v=399";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=399";
