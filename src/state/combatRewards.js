...
import { droppedEquipmentInsight } from "./lootInsight.js?v=325";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=325";
