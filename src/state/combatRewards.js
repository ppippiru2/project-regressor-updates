...
import { droppedEquipmentInsight } from "./lootInsight.js?v=345";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=345";
