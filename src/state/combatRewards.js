...
import { droppedEquipmentInsight } from "./lootInsight.js?v=508";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=508";
import { claimFirstCodexRecordGuide, claimFirstLootDropGuide } from "./tutorialGuidance.js?v=508";
import { t, tf } from "../localization/index.js?v=508";
import { resolveRegionCoreEvent } from "../story/coreEventCatalog.js?v=508";
