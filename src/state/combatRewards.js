...
import { droppedEquipmentInsight } from "./lootInsight.js?v=370";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=370";
