...
import { droppedEquipmentInsight } from "./lootInsight.js?v=362";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=362";
