...
import { droppedEquipmentInsight } from "./lootInsight.js?v=382";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=382";
