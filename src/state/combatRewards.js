...
import { droppedEquipmentInsight } from "./lootInsight.js?v=333";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=333";
