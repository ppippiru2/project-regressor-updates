...
import { droppedEquipmentInsight } from "./lootInsight.js?v=360";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=360";
