...
import { droppedEquipmentInsight } from "./lootInsight.js?v=375";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=375";
