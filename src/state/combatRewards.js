...
import { droppedEquipmentInsight } from "./lootInsight.js?v=359";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=359";
