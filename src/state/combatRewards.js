...
import { droppedEquipmentInsight } from "./lootInsight.js?v=349";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=349";
