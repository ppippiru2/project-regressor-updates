...
import { droppedEquipmentInsight } from "./lootInsight.js?v=415";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=415";
