...
import { droppedEquipmentInsight } from "./lootInsight.js?v=412";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=412";
