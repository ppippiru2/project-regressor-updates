...
import { droppedEquipmentInsight } from "./lootInsight.js?v=532";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=532";
import { claimFirstCodexRecordGuide, claimFirstLootDropGuide } from "./tutorialGuidance.js?v=532";
import { t, tf } from "../localization/index.js?v=532";
import { resolveRegionCoreEvent } from "../story/coreEventCatalog.js?v=532";
