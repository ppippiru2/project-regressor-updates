...
import { droppedEquipmentInsight } from "./lootInsight.js?v=367";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=367";
