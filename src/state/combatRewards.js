...
import { droppedEquipmentInsight } from "./lootInsight.js?v=394";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=394";
