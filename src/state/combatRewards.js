...
import { droppedEquipmentInsight } from "./lootInsight.js?v=331";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=331";
