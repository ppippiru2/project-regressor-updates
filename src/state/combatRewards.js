...
import { droppedEquipmentInsight } from "./lootInsight.js?v=384";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=384";
