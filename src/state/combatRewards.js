...
import { droppedEquipmentInsight } from "./lootInsight.js?v=374";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=374";
