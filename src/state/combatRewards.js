...
import { droppedEquipmentInsight } from "./lootInsight.js?v=410";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=410";
