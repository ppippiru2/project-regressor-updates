...
import { droppedEquipmentInsight } from "./lootInsight.js?v=400";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=400";
