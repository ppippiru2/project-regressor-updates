...
import { droppedEquipmentInsight } from "./lootInsight.js?v=364";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=364";
