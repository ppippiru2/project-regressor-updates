...
import { droppedEquipmentInsight } from "./lootInsight.js?v=341";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=341";
