...
import { droppedEquipmentInsight } from "./lootInsight.js?v=379";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=379";
