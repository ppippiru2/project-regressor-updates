...
import { droppedEquipmentInsight } from "./lootInsight.js?v=369";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=369";
