...
import { droppedEquipmentInsight } from "./lootInsight.js?v=363";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=363";
