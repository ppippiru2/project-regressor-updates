...
import { droppedEquipmentInsight } from "./lootInsight.js?v=327";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=327";
