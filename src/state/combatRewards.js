...
import { droppedEquipmentInsight } from "./lootInsight.js?v=386";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=386";
