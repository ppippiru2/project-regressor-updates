...
import { droppedEquipmentInsight } from "./lootInsight.js?v=356";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=356";
