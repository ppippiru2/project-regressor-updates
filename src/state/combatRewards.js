...
import { droppedEquipmentInsight } from "./lootInsight.js?v=409";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=409";
