...
import { droppedEquipmentInsight } from "./lootInsight.js?v=352";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=352";
