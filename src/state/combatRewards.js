...
import { droppedEquipmentInsight } from "./lootInsight.js?v=336";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=336";
