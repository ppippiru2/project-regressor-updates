...
import { droppedEquipmentInsight } from "./lootInsight.js?v=340";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=340";
