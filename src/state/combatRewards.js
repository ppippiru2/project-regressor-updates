...
import { droppedEquipmentInsight } from "./lootInsight.js?v=322";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=322";
