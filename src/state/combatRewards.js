...
import { droppedEquipmentInsight } from "./lootInsight.js?v=350";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=350";
