...
import { droppedEquipmentInsight } from "./lootInsight.js?v=326";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=326";
