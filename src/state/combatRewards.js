...
import { droppedEquipmentInsight } from "./lootInsight.js?v=380";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=380";
