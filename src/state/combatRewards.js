...
import { droppedEquipmentInsight } from "./lootInsight.js?v=404";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=404";
