...
import { droppedEquipmentInsight } from "./lootInsight.js?v=481";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=481";
import { claimFirstCodexRecordGuide, claimFirstLootDropGuide } from "./tutorialGuidance.js?v=481";
import { t, tf } from "../localization/index.js?v=481";
import { resolveRegionCoreEvent } from "../story/coreEventCatalog.js?v=481";
