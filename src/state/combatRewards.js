...
import { droppedEquipmentInsight } from "./lootInsight.js?v=334";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=334";
