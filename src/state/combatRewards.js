...
import { droppedEquipmentInsight } from "./lootInsight.js?v=373";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=373";
