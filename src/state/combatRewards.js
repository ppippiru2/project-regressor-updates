...
import { droppedEquipmentInsight } from "./lootInsight.js?v=393";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=393";
