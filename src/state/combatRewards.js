...
import { droppedEquipmentInsight } from "./lootInsight.js?v=328";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=328";
