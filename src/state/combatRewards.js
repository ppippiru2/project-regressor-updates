...
import { droppedEquipmentInsight } from "./lootInsight.js?v=337";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=337";
