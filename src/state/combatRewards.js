...
import { droppedEquipmentInsight } from "./lootInsight.js?v=408";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=408";
