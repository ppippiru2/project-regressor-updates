...
import { droppedEquipmentInsight } from "./lootInsight.js?v=391";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=391";
