...
import { droppedEquipmentInsight } from "./lootInsight.js?v=329";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=329";
