...
import { droppedEquipmentInsight } from "./lootInsight.js?v=407";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=407";
