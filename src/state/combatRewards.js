...
import { droppedEquipmentInsight } from "./lootInsight.js?v=347";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=347";
