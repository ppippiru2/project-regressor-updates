...
import { droppedEquipmentInsight } from "./lootInsight.js?v=280";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=280";
