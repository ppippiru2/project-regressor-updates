...
import { droppedEquipmentInsight } from "./lootInsight.js?v=522";
import { applyMonsterRewards, markRegionCompleted, regionExpMultiplier, rollMonsterDrops } from "./rewards.js?v=522";
import { claimFirstCodexRecordGuide, claimFirstLootDropGuide } from "./tutorialGuidance.js?v=522";
import { t, tf } from "../localization/index.js?v=522";
import { resolveRegionCoreEvent } from "../story/coreEventCatalog.js?v=522";
