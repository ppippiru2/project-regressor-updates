...
} from "./developerOptions.js?v=387";
import { DEFAULT_PORTRAIT_FRAME, normalizePortraitFrame } from "./portraitFrame.js?v=387";
import { normalizeTutorialFlags } from "./tutorialGuidance.js?v=387";
import { t, tf } from "../localization/index.js?v=387";

export { DEFAULT_DEVELOPER_OPTIONS } from "./developerOptions.js?v=387";
