import { STATIC_ASSET_REGISTRY } from "../assets/assetRegistry.js?v=535";
import {
...
import { MONSTER_BALANCE_DATA } from "../balance/monsterBalanceData.js?v=535";
import {
  candidateMonsterRewardLinkFor,
  TUTORIAL_MONSTER_POOL_DATA,
  TUTORIAL_MONSTER_POOL_REGIONS,
  TUTORIAL_MONSTER_POOL_VERSION,
} from "../balance/monsterCandidatePool.js?v=535";
import { monsters, regions } from "../data/worldData.js?v=535";
