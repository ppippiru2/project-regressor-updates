import { STATIC_ASSET_REGISTRY } from "../assets/assetRegistry.js?v=473";
import {
...
import { MONSTER_COMBAT_POSES } from "../config/monsterCombatDisplay.js?v=473";
import { MONSTER_BALANCE_DATA } from "../balance/monsterBalanceData.js?v=473";
import {
  candidateMonsterRewardLinkFor,
  TUTORIAL_MONSTER_POOL_DATA,
  TUTORIAL_MONSTER_POOL_REGIONS,
  TUTORIAL_MONSTER_POOL_VERSION,
} from "../balance/monsterCandidatePool.js?v=473";
import { monsters, regions } from "../data/worldData.js?v=473";
