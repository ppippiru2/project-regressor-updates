import { expToNext, monsterStats, rankCombatModifier, clamp } from "../combat/combatFormula.js?v=383";
import { primaryStats, skills } from "../data/coreData.js?v=383";
import { equipment } from "../data/equipmentData.js?v=383";
import { regions, monsters } from "../data/worldData.js?v=383";
import { PLAYER_INITIAL_STATS } from "../balance/playerGrowthBalance.js?v=383";
import { playerStats } from "../state/progression.js?v=383";
import { regionExpMultiplier } from "../state/rewards.js?v=383";
