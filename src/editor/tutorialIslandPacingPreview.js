import { expToNext, monsterStats, rankCombatModifier, clamp } from "../combat/combatFormula.js?v=388";
import { primaryStats, skills } from "../data/coreData.js?v=388";
import { equipment } from "../data/equipmentData.js?v=388";
import { regions, monsters } from "../data/worldData.js?v=388";
import { PLAYER_INITIAL_STATS } from "../balance/playerGrowthBalance.js?v=388";
import { playerStats } from "../state/progression.js?v=388";
import { regionExpMultiplier } from "../state/rewards.js?v=388";
