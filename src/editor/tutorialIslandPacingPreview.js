import { expToNext, monsterStats, rankCombatModifier, clamp } from "../combat/combatFormula.js?v=416";
import { primaryStats, skills } from "../data/coreData.js?v=416";
import { items } from "../data/itemData.js?v=416";
import { regions, monsters } from "../data/worldData.js?v=416";
import { PLAYER_INITIAL_STATS } from "../balance/playerGrowthBalance.js?v=416";
import { playerStats } from "../state/progression.js?v=416";
import { regionExpMultiplier } from "../state/rewards.js?v=416";
