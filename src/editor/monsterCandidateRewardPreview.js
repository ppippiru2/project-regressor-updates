import { TUTORIAL_MONSTER_POOL_DATA, TUTORIAL_MONSTER_POOL_REGIONS, TUTORIAL_MONSTER_POOL_VERSION, candidateMonsterRewardLinkFor } from "../balance/monsterCandidatePool.js?v=512";
import { lootItems } from "../data/itemData.js?v=512";
import { monsters, regions } from "../data/worldData.js?v=512";
import { getLocaleText } from "../localization/index.js?v=512";
