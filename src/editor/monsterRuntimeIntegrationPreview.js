import { STATIC_ASSET_REGISTRY, resolveAssetPath } from "../assets/assetRegistry.js?v=497";
import {
...
} from "../config/monsterRuntimeIntegrationPresets.js?v=497";
import { MONSTER_BATTLE_SPRITE_PRESETS } from "../config/monsterBattleSpritePresets.js?v=497";
import { MONSTER_COMBAT_POSES } from "../config/monsterCombatDisplay.js?v=497";
import { monsters } from "../data/worldData.js?v=497";
