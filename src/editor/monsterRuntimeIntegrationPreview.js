import { STATIC_ASSET_REGISTRY, resolveAssetPath } from "../assets/assetRegistry.js?v=527";
import {
...
} from "../config/monsterRuntimeIntegrationPresets.js?v=527";
import { MONSTER_BATTLE_SPRITE_PRESETS } from "../config/monsterBattleSpritePresets.js?v=527";
import { MONSTER_COMBAT_POSES } from "../config/monsterCombatDisplay.js?v=527";
import { monsters } from "../data/worldData.js?v=527";
