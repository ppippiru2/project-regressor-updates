import { STATIC_ASSET_REGISTRY, resolveAssetPath } from "../assets/assetRegistry.js?v=521";
import {
...
} from "../config/monsterRuntimeIntegrationPresets.js?v=521";
import { MONSTER_BATTLE_SPRITE_PRESETS } from "../config/monsterBattleSpritePresets.js?v=521";
import { MONSTER_COMBAT_POSES } from "../config/monsterCombatDisplay.js?v=521";
import { monsters } from "../data/worldData.js?v=521";
