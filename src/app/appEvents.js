import { bindCharacterCreationEvents } from "../ui/characterCreationEvents.js?v=444";
import { bindCombatControlEvents } from "../ui/combatControlEvents.js?v=444";
import { bindCombatInfoEvents } from "../ui/combatInfoEvents.js?v=444";
import { bindDelegatedClickEvents } from "../ui/delegatedClickEvents.js?v=444";
import { bindInfoTooltipEvents } from "../ui/infoTooltipEvents.js?v=444";
import { bindNavigationEvents } from "../ui/navigationEvents.js?v=444";
import { bindSaveLoadEvents } from "../ui/saveLoadEvents.js?v=444";
