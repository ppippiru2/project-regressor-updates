import { bindCharacterCreationEvents } from "../ui/characterCreationEvents.js?v=680";
import { bindCombatControlEvents } from "../ui/combatControlEvents.js?v=680";
import { bindCombatInfoEvents } from "../ui/combatInfoEvents.js?v=680";
import { bindDelegatedClickEvents } from "../ui/delegatedClickEvents.js?v=680";
import { bindInfoTooltipEvents } from "../ui/infoTooltipEvents.js?v=680";
import { bindNavigationEvents } from "../ui/navigationEvents.js?v=680";
import { bindSaveLoadEvents } from "../ui/saveLoadEvents.js?v=680";
