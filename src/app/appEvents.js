import { bindCharacterCreationEvents } from "../ui/characterCreationEvents.js?v=511";
import { bindCombatControlEvents } from "../ui/combatControlEvents.js?v=511";
import { bindCombatInfoEvents } from "../ui/combatInfoEvents.js?v=511";
import { bindDelegatedClickEvents } from "../ui/delegatedClickEvents.js?v=511";
import { bindInfoTooltipEvents } from "../ui/infoTooltipEvents.js?v=511";
import { bindNavigationEvents } from "../ui/navigationEvents.js?v=511";
import { bindSaveLoadEvents } from "../ui/saveLoadEvents.js?v=511";
