import { bindCharacterCreationEvents } from "../ui/characterCreationEvents.js?v=530";
import { bindCombatControlEvents } from "../ui/combatControlEvents.js?v=530";
import { bindCombatInfoEvents } from "../ui/combatInfoEvents.js?v=530";
import { bindDelegatedClickEvents } from "../ui/delegatedClickEvents.js?v=530";
import { bindInfoTooltipEvents } from "../ui/infoTooltipEvents.js?v=530";
import { bindNavigationEvents } from "../ui/navigationEvents.js?v=530";
import { bindSaveLoadEvents } from "../ui/saveLoadEvents.js?v=530";
