import { ASSET_MANIFEST, ASSET_SLOTS } from "./assetData.js?v=677";
import { monsterSpriteSlotKeyForPose } from "../config/monsterCombatDisplay.js?v=677";
import { resolveMonsterRuntimeIntegrationPreset } from "../config/monsterRuntimeIntegrationPresets.js?v=677";
