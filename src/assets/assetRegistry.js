import { ASSET_MANIFEST, ASSET_SLOTS } from "./assetData.js?v=500";
import { monsterSpriteSlotKeyForPose } from "../config/monsterCombatDisplay.js?v=500";
import { resolveMonsterRuntimeIntegrationPreset } from "../config/monsterRuntimeIntegrationPresets.js?v=500";
