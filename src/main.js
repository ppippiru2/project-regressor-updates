import {
  ...
  HELP_TEXT,
} from "./config/helpText.js?v=523";
import { bindAppEvents } from "./app/appEvents.js?v=523";
import { renderAppFrame, renderAppRegionList } from "./app/appRenderer.js?v=523";
import { handleObjectiveActionNavigation } from "./app/objectiveActionNavigation.js?v=523";
import {
  ACTIVE_SLOT_SYNC_INTERVAL_MS,
  MAX_LOG_LINES,
  OBJECTIVE_TICKER_INTERVAL_MS,
  SLOW_RENDER_INTERVAL_MS,
} from "./app/appRuntimeConfig.js?v=523";
import { finalizeSaveSessionTransition } from "./app/saveSessionFlow.js?v=523";
import { registerServiceWorker } from "./app/serviceWorkerRegistration.js";
import * as assetRegistryApi from "./assets/assetRegistry.js?v=523";
import { applyDomLocalization } from "./localization/domText.js?v=523";
import { t, tf } from "./localization/index.js?v=523";
import { clearCombatEffectLayers } from "./combat/combatEffects.js?v=523";
import { BULK_STAT_DEALLOCATE_AMOUNT } from "./balance/playerGrowthBalance.js?v=523";
import { CONTENT_PROFILE, applyContentProfileToDocument, exposeContentProfile } from "./content/contentProfile.js?v=523";
import {
  clamp,
...
import {
  ...
  stanceName,
} from "./combat/combatActions.js?v=523";
import {
  attackEffectType,
...
import { queueCombatTextEffect } from "./combat/combatFeedbackState.js?v=523";
import { resolveEnemyAttack, resolvePlayerAttack } from "./combat/combatDamage.js";
import { createDefeatedTargetPreview } from "./combat/combatDefeatPreview.js?v=523";
import {
  applyHealAction,
  applyResolvedEnemyAttack,
  applyResolvedPlayerAttack,
} from "./combat/combatActionResults.js?v=523";
import {
  ...
  resetHitComboState,
} from "./combat/combatHitResults.js?v=523";
import {
  ...
  createCombatRuntime,
  resetCombatRuntime,
} from "./combat/combatState.js?v=523";
import {
  bossBreakMessage,
  combatStartMessage,
  combatStopMessage,
...
} from "./combat/combatTick.js?v=523";
import { clearIntervalTimer, clearTimeoutTimer, restartIntervalTimer, restartTimeoutTimer } from "./combat/combatTimers.js?v=523";
import {
  applyIncomingDamageTestOption,
  applyOutgoingDamageTestOption,
} from "./combat/combatTestOptions.js?v=523";
import {
  displayNames,
  equipment,
  gateMaps,
...
} from "./state/save.js?v=523";
import {
  developerOptionLabel,
  normalizeDeveloperOptionValue,
  normalizeDeveloperOptions,
} from "./state/developerOptions.js?v=523";
import { createInitialState } from "./state/initialState.js?v=523";
import { applyImportedUiState, exportSavePayloadSnapshot, importSavePayloadText } from "./state/saveLoadActions.js?v=523";
import { playerStats } from "./state/progression.js?v=523";
import { starterTraitStatBonuses } from "./state/starterTraitEffects.js?v=523";
import { addInventoryItem } from "./state/inventory.js";
import { equipInventoryItem, resolveEquipmentSlot, unequipEquipmentSlot } from "./state/equipmentActions.js?v=523";
import { equipRecommendedItems } from "./state/recommendedEquipment.js?v=523";
import {
  beginGateReplay,
  ensureGateProgress as ensureGateProgressState,
  isGateProgressComplete,
  moveGateProgress,
} from "./state/regionProgress.js?v=523";
import {
...
} from "./state/profileActions.js?v=523";
import {
  ...
  saveCurrentToSlot,
  saveSlotLabel,
} from "./state/saveSlots.js?v=523";
import {
  createPendingSlotCreationSnapshot,
  restorePendingSlotCreationSnapshot,
} from "./state/saveSlotSession.js?v=523";

import { createGateNodeResolution, resolveGateNodeOutcome } from "./state/gateNodeActions.js?v=523";
import {
  ...
  stopCombatSession,
  toggleAutoHuntState,
} from "./state/combatSession.js?v=523";
import {
...
} from "./state/passiveRecovery.js?v=523";
import { applyMonsterDefeatRewards } from "./state/combatRewards.js?v=523";
import { applyPendingLevelProgression } from "./state/levelUpActions.js?v=523";
...
} from "./state/hyperActions.js?v=523";
import {
...
} from "./state/combatRuntimeUi.js?v=523";
import {
  BATTLE_SPRITE_MOTION_IDS,
  clearBattleSpriteMotions,
  triggerBattleSpriteMotion,
} from "./ui/battleSpriteMotion.js?v=523";
import {
  monsterAttackEffectPlacement,
  monsterAttackEffectType,
  resolveMonsterBattleSpritePreset,
} from "./config/monsterBattleSpritePresets.js?v=523";
import { resolveMonsterRuntimeAction } from "./config/monsterRuntimeIntegrationPresets.js?v=523";
import { resolvePlayerAttackEffectPlacement } from "./config/playerBattleSprites.js?v=523";
...
import { buyShopItem, sellInventoryItem } from "./state/shop.js?v=523";
import { applyStanceSelection } from "./state/stance.js?v=523";
import {
  allocatePlayerStat,
  ...
  resetAllocatedStats,
} from "./state/statAllocation.js?v=523";
import { applyRegionSelection, previewRegionState } from "./state/regionSelection.js?v=523";
import {
  advanceRegionMonsterEncounter,
  regionMonsterEncounterSeed,
  resolveRegionMonster,
} from "./state/regionMonsterPool.js?v=523";
import {
  stepObjectiveRotationState,
  toggleObjectiveAlertState,
  toggleObjectiveRotationModeState,
} from "./state/objectiveUiState.js?v=523";
import {
  ...
  shouldResetHitCombo,
} from "./state/playerResources.js?v=523";
import {
  hasSkillLoadout,
  resolveActiveLoadoutActions,
  resolveActiveLoadoutSkills,
  resolveActiveSkillLoadout,
} from "./state/skillLoadout.js?v=523";
import {
  claimFirstCombatGuide,
  claimRegionCoreEventGuide,
  createTutorialFlags,
} from "./state/tutorialGuidance.js?v=523";
import { claimOfflineAutoHuntReward, stampLastSeen } from "./state/offlineReward.js?v=523";
import { nodeName } from "./ui/renderRegion.js?v=523";
import { renderLog } from "./ui/renderCommon.js?v=523";
import { renderCombatSkillInfo } from "./ui/renderCombatActions.js?v=523";
import { renderHitCounter } from "./ui/renderCombatPulse.js?v=523";
import { setupCollapsiblePanels } from "./ui/panels.js?v=523";
import { setSaveStatus } from "./ui/saveSlotStatus.js?v=523";
import {
  activeViewId,
  activateView,
  resetCharacterCreationWizard,
  setCreationCancelMode,
} from "./ui/viewNavigation.js?v=523";
