import {
  ...
  HELP_TEXT,
} from "./config/helpText.js?v=677";
import { bindAppEvents } from "./app/appEvents.js?v=677";
import { renderAppFrame, renderAppRegionList } from "./app/appRenderer.js?v=677";
import { handleObjectiveActionNavigation } from "./app/objectiveActionNavigation.js?v=677";
import {
  ACTIVE_SLOT_SYNC_INTERVAL_MS,
  MAX_LOG_LINES,
  OBJECTIVE_TICKER_INTERVAL_MS,
  SLOW_RENDER_INTERVAL_MS,
} from "./app/appRuntimeConfig.js?v=677";
import { finalizeSaveSessionTransition } from "./app/saveSessionFlow.js?v=677";
import { registerServiceWorker } from "./app/serviceWorkerRegistration.js";
import * as assetRegistryApi from "./assets/assetRegistry.js?v=677";
import { applyDomLocalization } from "./localization/domText.js?v=677";
import { getLocaleText, t, tf } from "./localization/index.js?v=677";
import { clearCombatEffectLayers } from "./combat/combatEffects.js?v=677";
import { BULK_STAT_DEALLOCATE_AMOUNT } from "./balance/playerGrowthBalance.js?v=677";
import { CONTENT_PROFILE, applyContentProfileToDocument, exposeContentProfile } from "./content/contentProfile.js?v=677";
import {
  clamp,
...
import {
  ...
  stanceName,
} from "./combat/combatActions.js?v=677";
import {
  attackEffectType,
...
import { queueCombatTextEffect } from "./combat/combatFeedbackState.js?v=677";
import { resolveEnemyAttack, resolvePlayerAttack } from "./combat/combatDamage.js";
import { createDefeatedTargetPreview } from "./combat/combatDefeatPreview.js?v=677";
import {
  applyBuffAction,
  applyHealAction,
  applyResolvedEnemyAttack,
  applyResolvedPlayerAttack,
} from "./combat/combatActionResults.js?v=677";
import {
  ...
  resetHitComboState,
} from "./combat/combatHitResults.js?v=677";
import {
  ...
  createCombatRuntime,
  resetCombatRuntime,
} from "./combat/combatState.js?v=677";
import { isCombatStyleAction, isCombatStyleActive } from "./combat/combatStyleActions.js?v=677";
import {
  bossBreakMessage,
  combatStartMessage,
  combatStopMessage,
...
} from "./combat/combatTick.js?v=677";
import { clearIntervalTimer, clearTimeoutTimer, restartIntervalTimer, restartTimeoutTimer } from "./combat/combatTimers.js?v=677";
import {
  applyIncomingDamageTestOption,
  applyOutgoingDamageTestOption,
} from "./combat/combatTestOptions.js?v=677";
import {
  displayNames,
  equipment,
  gateMaps,
...
} from "./state/save.js?v=677";
import {
  developerOptionLabel,
  normalizeDeveloperOptionValue,
  normalizeDeveloperOptions,
} from "./state/developerOptions.js?v=677";
import { createInitialState } from "./state/initialState.js?v=677";
import { applyImportedUiState, exportSavePayloadSnapshot, importSavePayloadText } from "./state/saveLoadActions.js?v=677";
import { playerStats } from "./state/progression.js?v=677";
import { starterTraitStatBonuses } from "./state/starterTraitEffects.js?v=677";
import { addInventoryItem } from "./state/inventory.js";
import { equipInventoryItem, resolveEquipmentSlot, unequipEquipmentSlot } from "./state/equipmentActions.js?v=677";
import { equipRecommendedItems } from "./state/recommendedEquipment.js?v=677";
import {
  beginGateReplay,
  ensureGateProgress as ensureGateProgressState,
  isGateProgressComplete,
  moveGateProgress,
} from "./state/regionProgress.js?v=677";
import {
...
} from "./state/profileActions.js?v=677";
import {
  ...
  saveCurrentToSlot,
  saveSlotLabel,
} from "./state/saveSlots.js?v=677";
import {
  createPendingSlotCreationSnapshot,
  restorePendingSlotCreationSnapshot,
} from "./state/saveSlotSession.js?v=677";

import { createGateNodeResolution, resolveGateNodeOutcome } from "./state/gateNodeActions.js?v=677";
import {
  ...
  stopCombatSession,
  toggleAutoHuntState,
} from "./state/combatSession.js?v=677";
import {
...
} from "./state/passiveRecovery.js?v=677";
import { applyMonsterDefeatRewards } from "./state/combatRewards.js?v=677";
import { applyPendingLevelProgression } from "./state/levelUpActions.js?v=677";
import { applyPlayerDefeatRecovery } from "./state/defeatRecovery.js";
import { recordTutorialBossEvaluation } from "./state/tutorialBossEvaluation.js?v=677";
import {
  advanceDialogueRunAfterDefeat,
  ensureDialogueRunState,
  syncDialogueRunUnlockFlags,
} from "./state/dialogueProgression.js?v=677";
import {
  awardRegressionKarma,
  normalizeKarmaState,
} from "./state/karma.js?v=677";
import { resetWorldProgressForRegression } from "./state/regressionProgression.js?v=677";
import {
  applyRegressionCardSelection,
  createRegressionCardResyncState,
  normalizeRegressionCardState,
} from "./state/regressionCardState.js?v=677";
import {
...
import { createRegressionFateCardCatalog } from "./state/fateCardPool.js?v=677";
import {
...
} from "./state/hyperActions.js?v=677";
import {
...
} from "./state/combatRuntimeUi.js?v=677";
import {
  BATTLE_SPRITE_MOTION_IDS,
  clearBattleSpriteMotions,
  triggerBattleSpriteMotion,
} from "./ui/battleSpriteMotion.js?v=677";
import {
  monsterAttackEffectPlacement,
  monsterAttackEffectType,
  resolveMonsterBattleSpritePreset,
} from "./config/monsterBattleSpritePresets.js?v=677";
import { resolveMonsterRuntimeAction } from "./config/monsterRuntimeIntegrationPresets.js?v=677";
import { resolvePlayerAttackEffectPlacement } from "./config/playerBattleSprites.js?v=677";
...
import { buyShopItem, sellInventoryItem } from "./state/shop.js?v=677";
import { applyStanceSelection } from "./state/stance.js?v=677";
import {
  allocatePlayerStat,
  ...
  resetAllocatedStats,
} from "./state/statAllocation.js?v=677";
import { applyRegionSelection, previewRegionState } from "./state/regionSelection.js?v=677";
import {
  advanceRegionMonsterEncounter,
  regionMonsterEncounterSeed,
  resolveRegionMonster,
} from "./state/regionMonsterPool.js?v=677";
import {
  stepObjectiveRotationState,
  toggleObjectiveAlertState,
  toggleObjectiveRotationModeState,
} from "./state/objectiveUiState.js?v=677";
import {
...
import { claimOfflineAutoHuntReward, stampLastSeen } from "./state/offlineReward.js?v=677";
import { nodeName } from "./ui/renderRegion.js?v=677";
import { renderLog } from "./ui/renderCommon.js?v=677";
import { renderCombatSkillInfo } from "./ui/renderCombatActions.js?v=677";
import { renderHitCounter } from "./ui/renderCombatPulse.js?v=677";
import { playFateCardRevealMotion } from "./ui/fateCardRevealMotion.js?v=677";
import { setupCollapsiblePanels } from "./ui/panels.js?v=677";
import { setSaveStatus } from "./ui/saveSlotStatus.js?v=677";
import {
  activeViewId,
  activateView,
  resetCharacterCreationWizard,
  setCreationCancelMode,
} from "./ui/viewNavigation.js?v=677";
