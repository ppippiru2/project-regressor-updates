import {
  ...
  HELP_TEXT,
} from "./config/helpText.js?v=367";
import { bindAppEvents } from "./app/appEvents.js?v=367";
import { renderAppFrame, renderAppRegionList } from "./app/appRenderer.js?v=367";
import { handleObjectiveActionNavigation } from "./app/objectiveActionNavigation.js?v=367";
import {
  ACTIVE_SLOT_SYNC_INTERVAL_MS,
  MAX_LOG_LINES,
  OBJECTIVE_TICKER_INTERVAL_MS,
  SLOW_RENDER_INTERVAL_MS,
} from "./app/appRuntimeConfig.js?v=367";
import { finalizeSaveSessionTransition } from "./app/saveSessionFlow.js?v=367";
import { registerServiceWorker } from "./app/serviceWorkerRegistration.js";
import * as assetRegistryApi from "./assets/assetRegistry.js?v=367";
import { applyDomLocalization } from "./localization/domText.js?v=367";
import { t, tf } from "./localization/index.js?v=367";
import { clearCombatEffectLayers } from "./combat/combatEffects.js?v=367";
import { BULK_STAT_DEALLOCATE_AMOUNT } from "./balance/playerGrowthBalance.js?v=367";
import { CONTENT_PROFILE, applyContentProfileToDocument, exposeContentProfile } from "./content/contentProfile.js?v=367";
import {
  clamp,
...
import {
  ...
  stanceName,
} from "./combat/combatActions.js?v=367";
import {
  attackEffectType,
...
import { queueCombatTextEffect } from "./combat/combatFeedbackState.js?v=367";
import { resolveEnemyAttack, resolvePlayerAttack } from "./combat/combatDamage.js";
import { createDefeatedTargetPreview } from "./combat/combatDefeatPreview.js?v=367";
import {
  applyHealAction,
  applyResolvedEnemyAttack,
  applyResolvedPlayerAttack,
} from "./combat/combatActionResults.js?v=367";
import {
  advanceHitCombo,
  applySkillBreakDamage,
  playerHyperChargeFromSuccessfulHit,
  resetHitComboState,
} from "./combat/combatHitResults.js?v=367";
import {
  ...
  createCombatRuntime,
  resetCombatRuntime,
} from "./combat/combatState.js?v=367";
import {
  bossBreakMessage,
  combatStartMessage,
  combatStopMessage,
...
} from "./combat/combatTick.js?v=367";
import { clearIntervalTimer, clearTimeoutTimer, restartIntervalTimer, restartTimeoutTimer } from "./combat/combatTimers.js?v=367";
import {
  applyIncomingDamageTestOption,
  applyOutgoingDamageTestOption,
} from "./combat/combatTestOptions.js?v=367";
import {
  displayNames,
  equipment,
  gateMaps,
...
} from "./state/save.js?v=367";
import {
  developerOptionLabel,
  normalizeDeveloperOptionValue,
  normalizeDeveloperOptions,
} from "./state/developerOptions.js?v=367";
import { createInitialState } from "./state/initialState.js?v=367";
import { applyImportedUiState, exportSavePayloadSnapshot, importSavePayloadText } from "./state/saveLoadActions.js?v=367";
import { playerStats } from "./state/progression.js?v=367";
import { addInventoryItem } from "./state/inventory.js";
import { equipInventoryItem, resolveEquipmentSlot, unequipEquipmentSlot } from "./state/equipmentActions.js?v=367";
import { equipRecommendedItems } from "./state/recommendedEquipment.js?v=367";
import {
  beginGateReplay,
  ensureGateProgress as ensureGateProgressState,
  isGateProgressComplete,
  moveGateProgress,
} from "./state/regionProgress.js?v=367";
import {
  applyCharacterProfile,
  applyInitialCreationStats,
  createCharacterProfile,
  updatePlayerProfileSettings,
} from "./state/profileActions.js?v=367";
import {
  ...
  saveCurrentToSlot,
  saveSlotLabel,
} from "./state/saveSlots.js?v=367";
import {
  createPendingSlotCreationSnapshot,
  restorePendingSlotCreationSnapshot,
} from "./state/saveSlotSession.js?v=367";

import { createGateNodeResolution, resolveGateNodeOutcome } from "./state/gateNodeActions.js?v=367";
import {
  ...
  stopCombatSession,
  toggleAutoHuntState,
} from "./state/combatSession.js?v=367";
import {
...
} from "./state/passiveRecovery.js?v=367";
import { applyMonsterDefeatRewards } from "./state/combatRewards.js?v=367";
import { applyPendingLevelProgression } from "./state/levelUpActions.js?v=367";
...
} from "./state/hyperActions.js?v=367";
import {
...
} from "./state/combatRuntimeUi.js?v=367";
...
import { buyShopItem, sellInventoryItem } from "./state/shop.js?v=367";
import { applyStanceSelection } from "./state/stance.js?v=367";
import {
  allocatePlayerStat,
  ...
  resetAllocatedStats,
} from "./state/statAllocation.js?v=367";
import { applyRegionSelection, previewRegionState } from "./state/regionSelection.js?v=367";
import {
  stepObjectiveRotationState,
  toggleObjectiveAlertState,
  toggleObjectiveRotationModeState,
} from "./state/objectiveUiState.js?v=367";
import {
  ...
  shouldResetHitCombo,
} from "./state/playerResources.js?v=367";
import {
  hasSkillLoadout,
  resolveActiveLoadoutActions,
  resolveActiveLoadoutSkills,
  resolveActiveSkillLoadout,
} from "./state/skillLoadout.js?v=367";
import { claimOfflineAutoHuntReward, stampLastSeen } from "./state/offlineReward.js?v=367";
import { nodeName } from "./ui/renderRegion.js?v=367";
import { renderLog } from "./ui/renderCommon.js?v=367";
import { renderCombatSkillInfo } from "./ui/renderCombatActions.js?v=367";
import { renderHitCounter } from "./ui/renderCombatPulse.js?v=367";
import { setupCollapsiblePanels } from "./ui/panels.js?v=367";
import { setSaveStatus } from "./ui/saveSlotStatus.js?v=367";
import {
  activeViewId,
  activateView,
  resetCharacterCreationWizard,
  setCreationCancelMode,
} from "./ui/viewNavigation.js?v=367";
