import {
  ...
  HELP_TEXT,
} from "./config/helpText.js?v=443";
import { bindAppEvents } from "./app/appEvents.js?v=443";
import { renderAppFrame, renderAppRegionList } from "./app/appRenderer.js?v=443";
import { handleObjectiveActionNavigation } from "./app/objectiveActionNavigation.js?v=443";
import {
  ACTIVE_SLOT_SYNC_INTERVAL_MS,
  MAX_LOG_LINES,
  OBJECTIVE_TICKER_INTERVAL_MS,
  SLOW_RENDER_INTERVAL_MS,
} from "./app/appRuntimeConfig.js?v=443";
import { finalizeSaveSessionTransition } from "./app/saveSessionFlow.js?v=443";
import { registerServiceWorker } from "./app/serviceWorkerRegistration.js";
import * as assetRegistryApi from "./assets/assetRegistry.js?v=443";
import { applyDomLocalization } from "./localization/domText.js?v=443";
import { t, tf } from "./localization/index.js?v=443";
import { clearCombatEffectLayers } from "./combat/combatEffects.js?v=443";
import { BULK_STAT_DEALLOCATE_AMOUNT } from "./balance/playerGrowthBalance.js?v=443";
import { CONTENT_PROFILE, applyContentProfileToDocument, exposeContentProfile } from "./content/contentProfile.js?v=443";
import {
  clamp,
...
import {
  ...
  stanceName,
} from "./combat/combatActions.js?v=443";
import {
  attackEffectType,
...
import { queueCombatTextEffect } from "./combat/combatFeedbackState.js?v=443";
import { resolveEnemyAttack, resolvePlayerAttack } from "./combat/combatDamage.js";
import { createDefeatedTargetPreview } from "./combat/combatDefeatPreview.js?v=443";
import {
  applyHealAction,
  applyResolvedEnemyAttack,
  applyResolvedPlayerAttack,
} from "./combat/combatActionResults.js?v=443";
import {
  advanceHitCombo,
  applySkillBreakDamage,
  playerHyperChargeFromSuccessfulHit,
  resetHitComboState,
} from "./combat/combatHitResults.js?v=443";
import {
  ...
  createCombatRuntime,
  resetCombatRuntime,
} from "./combat/combatState.js?v=443";
import {
  bossBreakMessage,
  combatStartMessage,
  combatStopMessage,
...
} from "./combat/combatTick.js?v=443";
import { clearIntervalTimer, clearTimeoutTimer, restartIntervalTimer, restartTimeoutTimer } from "./combat/combatTimers.js?v=443";
import {
  applyIncomingDamageTestOption,
  applyOutgoingDamageTestOption,
} from "./combat/combatTestOptions.js?v=443";
import {
  displayNames,
  equipment,
  gateMaps,
...
} from "./state/save.js?v=443";
import {
  developerOptionLabel,
  normalizeDeveloperOptionValue,
  normalizeDeveloperOptions,
} from "./state/developerOptions.js?v=443";
import { createInitialState } from "./state/initialState.js?v=443";
import { applyImportedUiState, exportSavePayloadSnapshot, importSavePayloadText } from "./state/saveLoadActions.js?v=443";
import { playerStats } from "./state/progression.js?v=443";
import { starterTraitStatBonuses } from "./state/starterTraitEffects.js?v=443";
import { addInventoryItem } from "./state/inventory.js";
import { equipInventoryItem, resolveEquipmentSlot, unequipEquipmentSlot } from "./state/equipmentActions.js?v=443";
import { equipRecommendedItems } from "./state/recommendedEquipment.js?v=443";
import {
  beginGateReplay,
  ensureGateProgress as ensureGateProgressState,
  isGateProgressComplete,
  moveGateProgress,
} from "./state/regionProgress.js?v=443";
import {
...
} from "./state/profileActions.js?v=443";
import {
  ...
  saveCurrentToSlot,
  saveSlotLabel,
} from "./state/saveSlots.js?v=443";
import {
  createPendingSlotCreationSnapshot,
  restorePendingSlotCreationSnapshot,
} from "./state/saveSlotSession.js?v=443";

import { createGateNodeResolution, resolveGateNodeOutcome } from "./state/gateNodeActions.js?v=443";
import {
  ...
  stopCombatSession,
  toggleAutoHuntState,
} from "./state/combatSession.js?v=443";
import {
...
} from "./state/passiveRecovery.js?v=443";
import { applyMonsterDefeatRewards } from "./state/combatRewards.js?v=443";
import { applyPendingLevelProgression } from "./state/levelUpActions.js?v=443";
...
} from "./state/hyperActions.js?v=443";
import {
...
} from "./state/combatRuntimeUi.js?v=443";
import {
  BATTLE_SPRITE_MOTION_IDS,
  clearBattleSpriteMotions,
  triggerBattleSpriteMotion,
} from "./ui/battleSpriteMotion.js?v=443";
import {
  monsterAttackEffectPlacement,
  monsterAttackEffectType,
  resolveMonsterBattleSpritePreset,
} from "./config/monsterBattleSpritePresets.js?v=443";
import { resolvePlayerAttackEffectPlacement } from "./config/playerBattleSprites.js?v=443";
...
import { buyShopItem, sellInventoryItem } from "./state/shop.js?v=443";
import { applyStanceSelection } from "./state/stance.js?v=443";
import {
  allocatePlayerStat,
  ...
  resetAllocatedStats,
} from "./state/statAllocation.js?v=443";
import { applyRegionSelection, previewRegionState } from "./state/regionSelection.js?v=443";
import {
  advanceRegionMonsterEncounter,
  regionMonsterEncounterSeed,
  resolveRegionMonster,
} from "./state/regionMonsterPool.js?v=443";
import {
  stepObjectiveRotationState,
  toggleObjectiveAlertState,
  toggleObjectiveRotationModeState,
} from "./state/objectiveUiState.js?v=443";
import {
  ...
  shouldResetHitCombo,
} from "./state/playerResources.js?v=443";
import {
  hasSkillLoadout,
  resolveActiveLoadoutActions,
  resolveActiveLoadoutSkills,
  resolveActiveSkillLoadout,
} from "./state/skillLoadout.js?v=443";
import {
  claimFirstCombatGuide,
  claimRegionCoreEventGuide,
  createTutorialFlags,
} from "./state/tutorialGuidance.js?v=443";
import { claimOfflineAutoHuntReward, stampLastSeen } from "./state/offlineReward.js?v=443";
import { nodeName } from "./ui/renderRegion.js?v=443";
import { renderLog } from "./ui/renderCommon.js?v=443";
import { renderCombatSkillInfo } from "./ui/renderCombatActions.js?v=443";
import { renderHitCounter } from "./ui/renderCombatPulse.js?v=443";
import { setupCollapsiblePanels } from "./ui/panels.js?v=443";
import { setSaveStatus } from "./ui/saveSlotStatus.js?v=443";
import {
  activeViewId,
  activateView,
  resetCharacterCreationWizard,
  setCreationCancelMode,
} from "./ui/viewNavigation.js?v=443";
