import {
  ...
  HELP_TEXT,
} from "./config/helpText.js?v=527";
import { bindAppEvents } from "./app/appEvents.js?v=527";
import { renderAppFrame, renderAppRegionList } from "./app/appRenderer.js?v=527";
import { handleObjectiveActionNavigation } from "./app/objectiveActionNavigation.js?v=527";
import {
  ACTIVE_SLOT_SYNC_INTERVAL_MS,
  MAX_LOG_LINES,
  OBJECTIVE_TICKER_INTERVAL_MS,
  SLOW_RENDER_INTERVAL_MS,
} from "./app/appRuntimeConfig.js?v=527";
import { finalizeSaveSessionTransition } from "./app/saveSessionFlow.js?v=527";
import { registerServiceWorker } from "./app/serviceWorkerRegistration.js";
import * as assetRegistryApi from "./assets/assetRegistry.js?v=527";
import { applyDomLocalization } from "./localization/domText.js?v=527";
import { t, tf } from "./localization/index.js?v=527";
import { clearCombatEffectLayers } from "./combat/combatEffects.js?v=527";
import { BULK_STAT_DEALLOCATE_AMOUNT } from "./balance/playerGrowthBalance.js?v=527";
import { CONTENT_PROFILE, applyContentProfileToDocument, exposeContentProfile } from "./content/contentProfile.js?v=527";
import {
  clamp,
...
import {
  ...
  stanceName,
} from "./combat/combatActions.js?v=527";
import {
  attackEffectType,
...
import { queueCombatTextEffect } from "./combat/combatFeedbackState.js?v=527";
import { resolveEnemyAttack, resolvePlayerAttack } from "./combat/combatDamage.js";
import { createDefeatedTargetPreview } from "./combat/combatDefeatPreview.js?v=527";
import {
  applyHealAction,
  applyResolvedEnemyAttack,
  applyResolvedPlayerAttack,
} from "./combat/combatActionResults.js?v=527";
import {
  ...
  resetHitComboState,
} from "./combat/combatHitResults.js?v=527";
import {
  ...
  createCombatRuntime,
  resetCombatRuntime,
} from "./combat/combatState.js?v=527";
import {
  bossBreakMessage,
  combatStartMessage,
  combatStopMessage,
...
} from "./combat/combatTick.js?v=527";
import { clearIntervalTimer, clearTimeoutTimer, restartIntervalTimer, restartTimeoutTimer } from "./combat/combatTimers.js?v=527";
import {
  applyIncomingDamageTestOption,
  applyOutgoingDamageTestOption,
} from "./combat/combatTestOptions.js?v=527";
import {
  displayNames,
  equipment,
  gateMaps,
...
} from "./state/save.js?v=527";
import {
  developerOptionLabel,
  normalizeDeveloperOptionValue,
  normalizeDeveloperOptions,
} from "./state/developerOptions.js?v=527";
import { createInitialState } from "./state/initialState.js?v=527";
import { applyImportedUiState, exportSavePayloadSnapshot, importSavePayloadText } from "./state/saveLoadActions.js?v=527";
import { playerStats } from "./state/progression.js?v=527";
import { starterTraitStatBonuses } from "./state/starterTraitEffects.js?v=527";
import { addInventoryItem } from "./state/inventory.js";
import { equipInventoryItem, resolveEquipmentSlot, unequipEquipmentSlot } from "./state/equipmentActions.js?v=527";
import { equipRecommendedItems } from "./state/recommendedEquipment.js?v=527";
import {
  beginGateReplay,
  ensureGateProgress as ensureGateProgressState,
  isGateProgressComplete,
  moveGateProgress,
} from "./state/regionProgress.js?v=527";
import {
...
} from "./state/profileActions.js?v=527";
import {
  ...
  saveCurrentToSlot,
  saveSlotLabel,
} from "./state/saveSlots.js?v=527";
import {
  createPendingSlotCreationSnapshot,
  restorePendingSlotCreationSnapshot,
} from "./state/saveSlotSession.js?v=527";

import { createGateNodeResolution, resolveGateNodeOutcome } from "./state/gateNodeActions.js?v=527";
import {
  ...
  stopCombatSession,
  toggleAutoHuntState,
} from "./state/combatSession.js?v=527";
import {
...
} from "./state/passiveRecovery.js?v=527";
import { applyMonsterDefeatRewards } from "./state/combatRewards.js?v=527";
import { applyPendingLevelProgression } from "./state/levelUpActions.js?v=527";
...
} from "./state/hyperActions.js?v=527";
import {
...
} from "./state/combatRuntimeUi.js?v=527";
import {
  BATTLE_SPRITE_MOTION_IDS,
  clearBattleSpriteMotions,
  triggerBattleSpriteMotion,
} from "./ui/battleSpriteMotion.js?v=527";
import {
  monsterAttackEffectPlacement,
  monsterAttackEffectType,
  resolveMonsterBattleSpritePreset,
} from "./config/monsterBattleSpritePresets.js?v=527";
import { resolveMonsterRuntimeAction } from "./config/monsterRuntimeIntegrationPresets.js?v=527";
import { resolvePlayerAttackEffectPlacement } from "./config/playerBattleSprites.js?v=527";
...
import { buyShopItem, sellInventoryItem } from "./state/shop.js?v=527";
import { applyStanceSelection } from "./state/stance.js?v=527";
import {
  allocatePlayerStat,
  ...
  resetAllocatedStats,
} from "./state/statAllocation.js?v=527";
import { applyRegionSelection, previewRegionState } from "./state/regionSelection.js?v=527";
import {
  advanceRegionMonsterEncounter,
  regionMonsterEncounterSeed,
  resolveRegionMonster,
} from "./state/regionMonsterPool.js?v=527";
import {
  stepObjectiveRotationState,
  toggleObjectiveAlertState,
  toggleObjectiveRotationModeState,
} from "./state/objectiveUiState.js?v=527";
import {
  ...
  shouldResetHitCombo,
} from "./state/playerResources.js?v=527";
import {
  hasSkillLoadout,
  resolveActiveLoadoutActions,
  resolveActiveLoadoutSkills,
  resolveActiveSkillLoadout,
} from "./state/skillLoadout.js?v=527";
import {
  claimFirstCombatGuide,
  claimRegionCoreEventGuide,
  createTutorialFlags,
} from "./state/tutorialGuidance.js?v=527";
import { claimOfflineAutoHuntReward, stampLastSeen } from "./state/offlineReward.js?v=527";
import { nodeName } from "./ui/renderRegion.js?v=527";
import { renderLog } from "./ui/renderCommon.js?v=527";
import { renderCombatSkillInfo } from "./ui/renderCombatActions.js?v=527";
import { renderHitCounter } from "./ui/renderCombatPulse.js?v=527";
import { setupCollapsiblePanels } from "./ui/panels.js?v=527";
import { setSaveStatus } from "./ui/saveSlotStatus.js?v=527";
import {
  activeViewId,
  activateView,
  resetCharacterCreationWizard,
  setCreationCancelMode,
} from "./ui/viewNavigation.js?v=527";
