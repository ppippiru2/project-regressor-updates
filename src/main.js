import {
  ...
  HELP_TEXT,
} from "./config/helpText.js?v=399";
import { bindAppEvents } from "./app/appEvents.js?v=399";
import { renderAppFrame, renderAppRegionList } from "./app/appRenderer.js?v=399";
import { handleObjectiveActionNavigation } from "./app/objectiveActionNavigation.js?v=399";
import {
  ACTIVE_SLOT_SYNC_INTERVAL_MS,
  MAX_LOG_LINES,
  OBJECTIVE_TICKER_INTERVAL_MS,
  SLOW_RENDER_INTERVAL_MS,
} from "./app/appRuntimeConfig.js?v=399";
import { finalizeSaveSessionTransition } from "./app/saveSessionFlow.js?v=399";
import { registerServiceWorker } from "./app/serviceWorkerRegistration.js";
import * as assetRegistryApi from "./assets/assetRegistry.js?v=399";
import { applyDomLocalization } from "./localization/domText.js?v=399";
import { t, tf } from "./localization/index.js?v=399";
import { clearCombatEffectLayers } from "./combat/combatEffects.js?v=399";
import { BULK_STAT_DEALLOCATE_AMOUNT } from "./balance/playerGrowthBalance.js?v=399";
import { CONTENT_PROFILE, applyContentProfileToDocument, exposeContentProfile } from "./content/contentProfile.js?v=399";
import {
  clamp,
...
import {
  ...
  stanceName,
} from "./combat/combatActions.js?v=399";
import {
  attackEffectType,
...
import { queueCombatTextEffect } from "./combat/combatFeedbackState.js?v=399";
import { resolveEnemyAttack, resolvePlayerAttack } from "./combat/combatDamage.js";
import { createDefeatedTargetPreview } from "./combat/combatDefeatPreview.js?v=399";
import {
  applyHealAction,
  applyResolvedEnemyAttack,
  applyResolvedPlayerAttack,
} from "./combat/combatActionResults.js?v=399";
import {
  advanceHitCombo,
  applySkillBreakDamage,
  playerHyperChargeFromSuccessfulHit,
  resetHitComboState,
} from "./combat/combatHitResults.js?v=399";
import {
  ...
  createCombatRuntime,
  resetCombatRuntime,
} from "./combat/combatState.js?v=399";
import {
  bossBreakMessage,
  combatStartMessage,
  combatStopMessage,
...
} from "./combat/combatTick.js?v=399";
import { clearIntervalTimer, clearTimeoutTimer, restartIntervalTimer, restartTimeoutTimer } from "./combat/combatTimers.js?v=399";
import {
  applyIncomingDamageTestOption,
  applyOutgoingDamageTestOption,
} from "./combat/combatTestOptions.js?v=399";
import {
  displayNames,
  equipment,
  gateMaps,
...
} from "./state/save.js?v=399";
import {
  developerOptionLabel,
  normalizeDeveloperOptionValue,
  normalizeDeveloperOptions,
} from "./state/developerOptions.js?v=399";
import { createInitialState } from "./state/initialState.js?v=399";
import { applyImportedUiState, exportSavePayloadSnapshot, importSavePayloadText } from "./state/saveLoadActions.js?v=399";
import { playerStats } from "./state/progression.js?v=399";
import { starterTraitStatBonuses } from "./state/starterTraitEffects.js?v=399";
import { addInventoryItem } from "./state/inventory.js";
import { equipInventoryItem, resolveEquipmentSlot, unequipEquipmentSlot } from "./state/equipmentActions.js?v=399";
import { equipRecommendedItems } from "./state/recommendedEquipment.js?v=399";
import {
  beginGateReplay,
  ensureGateProgress as ensureGateProgressState,
  isGateProgressComplete,
  moveGateProgress,
} from "./state/regionProgress.js?v=399";
import {
...
} from "./state/profileActions.js?v=399";
import {
  ...
  saveCurrentToSlot,
  saveSlotLabel,
} from "./state/saveSlots.js?v=399";
import {
  createPendingSlotCreationSnapshot,
  restorePendingSlotCreationSnapshot,
} from "./state/saveSlotSession.js?v=399";

import { createGateNodeResolution, resolveGateNodeOutcome } from "./state/gateNodeActions.js?v=399";
import {
  ...
  stopCombatSession,
  toggleAutoHuntState,
} from "./state/combatSession.js?v=399";
import {
...
} from "./state/passiveRecovery.js?v=399";
import { applyMonsterDefeatRewards } from "./state/combatRewards.js?v=399";
import { applyPendingLevelProgression } from "./state/levelUpActions.js?v=399";
...
} from "./state/hyperActions.js?v=399";
import {
...
import { buyShopItem, sellInventoryItem } from "./state/shop.js?v=399";
import { applyStanceSelection } from "./state/stance.js?v=399";
import {
  allocatePlayerStat,
  ...
  resetAllocatedStats,
} from "./state/statAllocation.js?v=399";
import { applyRegionSelection, previewRegionState } from "./state/regionSelection.js?v=399";
import {
  stepObjectiveRotationState,
  toggleObjectiveAlertState,
  toggleObjectiveRotationModeState,
} from "./state/objectiveUiState.js?v=399";
import {
  ...
  shouldResetHitCombo,
} from "./state/playerResources.js?v=399";
import {
  hasSkillLoadout,
  resolveActiveLoadoutActions,
  resolveActiveLoadoutSkills,
  resolveActiveSkillLoadout,
} from "./state/skillLoadout.js?v=399";
import { claimFirstCombatGuide, createTutorialFlags } from "./state/tutorialGuidance.js?v=399";
import { claimOfflineAutoHuntReward, stampLastSeen } from "./state/offlineReward.js?v=399";
import { nodeName } from "./ui/renderRegion.js?v=399";
import { renderLog } from "./ui/renderCommon.js?v=399";
import { renderCombatSkillInfo } from "./ui/renderCombatActions.js?v=399";
import { renderHitCounter } from "./ui/renderCombatPulse.js?v=399";
import { setupCollapsiblePanels } from "./ui/panels.js?v=399";
import { setSaveStatus } from "./ui/saveSlotStatus.js?v=399";
import {
  activeViewId,
  activateView,
  resetCharacterCreationWizard,
  setCreationCancelMode,
} from "./ui/viewNavigation.js?v=399";
