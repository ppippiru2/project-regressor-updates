import {
  ...
  HELP_TEXT,
} from "./config/helpText.js?v=534";
import { bindAppEvents } from "./app/appEvents.js?v=534";
import { renderAppFrame, renderAppRegionList } from "./app/appRenderer.js?v=534";
import { handleObjectiveActionNavigation } from "./app/objectiveActionNavigation.js?v=534";
import {
  ACTIVE_SLOT_SYNC_INTERVAL_MS,
  MAX_LOG_LINES,
  OBJECTIVE_TICKER_INTERVAL_MS,
  SLOW_RENDER_INTERVAL_MS,
} from "./app/appRuntimeConfig.js?v=534";
import { finalizeSaveSessionTransition } from "./app/saveSessionFlow.js?v=534";
import { registerServiceWorker } from "./app/serviceWorkerRegistration.js";
import * as assetRegistryApi from "./assets/assetRegistry.js?v=534";
import { applyDomLocalization } from "./localization/domText.js?v=534";
import { t, tf } from "./localization/index.js?v=534";
import { clearCombatEffectLayers } from "./combat/combatEffects.js?v=534";
import { BULK_STAT_DEALLOCATE_AMOUNT } from "./balance/playerGrowthBalance.js?v=534";
import { CONTENT_PROFILE, applyContentProfileToDocument, exposeContentProfile } from "./content/contentProfile.js?v=534";
import {
  clamp,
...
import {
  ...
  stanceName,
} from "./combat/combatActions.js?v=534";
import {
  attackEffectType,
...
import { queueCombatTextEffect } from "./combat/combatFeedbackState.js?v=534";
import { resolveEnemyAttack, resolvePlayerAttack } from "./combat/combatDamage.js";
import { createDefeatedTargetPreview } from "./combat/combatDefeatPreview.js?v=534";
import {
  applyHealAction,
  applyResolvedEnemyAttack,
  applyResolvedPlayerAttack,
} from "./combat/combatActionResults.js?v=534";
import {
  ...
  resetHitComboState,
} from "./combat/combatHitResults.js?v=534";
import {
  ...
  createCombatRuntime,
  resetCombatRuntime,
} from "./combat/combatState.js?v=534";
import {
  bossBreakMessage,
  combatStartMessage,
  combatStopMessage,
...
} from "./combat/combatTick.js?v=534";
import { clearIntervalTimer, clearTimeoutTimer, restartIntervalTimer, restartTimeoutTimer } from "./combat/combatTimers.js?v=534";
import {
  applyIncomingDamageTestOption,
  applyOutgoingDamageTestOption,
} from "./combat/combatTestOptions.js?v=534";
import {
  displayNames,
  equipment,
  gateMaps,
...
} from "./state/save.js?v=534";
import {
  developerOptionLabel,
  normalizeDeveloperOptionValue,
  normalizeDeveloperOptions,
} from "./state/developerOptions.js?v=534";
import { createInitialState } from "./state/initialState.js?v=534";
import { applyImportedUiState, exportSavePayloadSnapshot, importSavePayloadText } from "./state/saveLoadActions.js?v=534";
import { playerStats } from "./state/progression.js?v=534";
import { starterTraitStatBonuses } from "./state/starterTraitEffects.js?v=534";
import { addInventoryItem } from "./state/inventory.js";
import { equipInventoryItem, resolveEquipmentSlot, unequipEquipmentSlot } from "./state/equipmentActions.js?v=534";
import { equipRecommendedItems } from "./state/recommendedEquipment.js?v=534";
import {
  beginGateReplay,
  ensureGateProgress as ensureGateProgressState,
  isGateProgressComplete,
  moveGateProgress,
} from "./state/regionProgress.js?v=534";
import {
...
} from "./state/profileActions.js?v=534";
import {
  ...
  saveCurrentToSlot,
  saveSlotLabel,
} from "./state/saveSlots.js?v=534";
import {
  createPendingSlotCreationSnapshot,
  restorePendingSlotCreationSnapshot,
} from "./state/saveSlotSession.js?v=534";

import { createGateNodeResolution, resolveGateNodeOutcome } from "./state/gateNodeActions.js?v=534";
import {
  ...
  stopCombatSession,
  toggleAutoHuntState,
} from "./state/combatSession.js?v=534";
import {
...
} from "./state/passiveRecovery.js?v=534";
import { applyMonsterDefeatRewards } from "./state/combatRewards.js?v=534";
import { applyPendingLevelProgression } from "./state/levelUpActions.js?v=534";
...
} from "./state/hyperActions.js?v=534";
import {
...
} from "./state/combatRuntimeUi.js?v=534";
import {
  BATTLE_SPRITE_MOTION_IDS,
  clearBattleSpriteMotions,
  triggerBattleSpriteMotion,
} from "./ui/battleSpriteMotion.js?v=534";
import {
  monsterAttackEffectPlacement,
  monsterAttackEffectType,
  resolveMonsterBattleSpritePreset,
} from "./config/monsterBattleSpritePresets.js?v=534";
import { resolveMonsterRuntimeAction } from "./config/monsterRuntimeIntegrationPresets.js?v=534";
import { resolvePlayerAttackEffectPlacement } from "./config/playerBattleSprites.js?v=534";
...
import { buyShopItem, sellInventoryItem } from "./state/shop.js?v=534";
import { applyStanceSelection } from "./state/stance.js?v=534";
import {
  allocatePlayerStat,
  ...
  resetAllocatedStats,
} from "./state/statAllocation.js?v=534";
import { applyRegionSelection, previewRegionState } from "./state/regionSelection.js?v=534";
import {
  advanceRegionMonsterEncounter,
  regionMonsterEncounterSeed,
  resolveRegionMonster,
} from "./state/regionMonsterPool.js?v=534";
import {
  stepObjectiveRotationState,
  toggleObjectiveAlertState,
  toggleObjectiveRotationModeState,
} from "./state/objectiveUiState.js?v=534";
import {
  ...
  shouldResetHitCombo,
} from "./state/playerResources.js?v=534";
import {
  hasSkillLoadout,
  resolveActiveLoadoutActions,
  resolveActiveLoadoutSkills,
  resolveActiveSkillLoadout,
} from "./state/skillLoadout.js?v=534";
import {
  claimFirstCombatGuide,
  claimRegionCoreEventGuide,
  createTutorialFlags,
} from "./state/tutorialGuidance.js?v=534";
import { claimOfflineAutoHuntReward, stampLastSeen } from "./state/offlineReward.js?v=534";
import { nodeName } from "./ui/renderRegion.js?v=534";
import { renderLog } from "./ui/renderCommon.js?v=534";
import { renderCombatSkillInfo } from "./ui/renderCombatActions.js?v=534";
import { renderHitCounter } from "./ui/renderCombatPulse.js?v=534";
import { setupCollapsiblePanels } from "./ui/panels.js?v=534";
import { setSaveStatus } from "./ui/saveSlotStatus.js?v=534";
import {
  activeViewId,
  activateView,
  resetCharacterCreationWizard,
  setCreationCancelMode,
} from "./ui/viewNavigation.js?v=534";
