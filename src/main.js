import {
  ...
  HELP_TEXT,
} from "./config/helpText.js?v=680";
import { bindAppEvents } from "./app/appEvents.js?v=680";
import { renderAppFrame, renderAppRegionList } from "./app/appRenderer.js?v=680";
import { handleObjectiveActionNavigation } from "./app/objectiveActionNavigation.js?v=680";
import {
  ACTIVE_SLOT_SYNC_INTERVAL_MS,
  MAX_LOG_LINES,
  OBJECTIVE_TICKER_INTERVAL_MS,
  SLOW_RENDER_INTERVAL_MS,
} from "./app/appRuntimeConfig.js?v=680";
import { finalizeSaveSessionTransition } from "./app/saveSessionFlow.js?v=680";
import { registerServiceWorker } from "./app/serviceWorkerRegistration.js";
import * as assetRegistryApi from "./assets/assetRegistry.js?v=680";
import { applyDomLocalization } from "./localization/domText.js?v=680";
import { getLocaleText, t, tf } from "./localization/index.js?v=680";
import { clearCombatEffectLayers } from "./combat/combatEffects.js?v=680";
import { BULK_STAT_DEALLOCATE_AMOUNT } from "./balance/playerGrowthBalance.js?v=680";
import { CONTENT_PROFILE, applyContentProfileToDocument, exposeContentProfile } from "./content/contentProfile.js?v=680";
import {
  clamp,
...
import {
  ...
  stanceName,
} from "./combat/combatActions.js?v=680";
import {
  attackEffectType,
...
import { queueCombatTextEffect } from "./combat/combatFeedbackState.js?v=680";
import { resolveEnemyAttack, resolvePlayerAttack } from "./combat/combatDamage.js";
import { createDefeatedTargetPreview } from "./combat/combatDefeatPreview.js?v=680";
import {
  applyBuffAction,
  applyHealAction,
  applyResolvedEnemyAttack,
  applyResolvedPlayerAttack,
} from "./combat/combatActionResults.js?v=680";
import {
  ...
  resetHitComboState,
} from "./combat/combatHitResults.js?v=680";
import {
  ...
  createCombatRuntime,
  resetCombatRuntime,
} from "./combat/combatState.js?v=680";
import { isCombatStyleAction, isCombatStyleActive } from "./combat/combatStyleActions.js?v=680";
import {
  bossBreakMessage,
  combatStartMessage,
  combatStopMessage,
...
} from "./combat/combatTick.js?v=680";
import { clearIntervalTimer, clearTimeoutTimer, restartIntervalTimer, restartTimeoutTimer } from "./combat/combatTimers.js?v=680";
import {
  applyIncomingDamageTestOption,
  applyOutgoingDamageTestOption,
} from "./combat/combatTestOptions.js?v=680";
import {
  displayNames,
  equipment,
  gateMaps,
...
} from "./state/save.js?v=680";
import {
  developerOptionLabel,
  normalizeDeveloperOptionValue,
  normalizeDeveloperOptions,
} from "./state/developerOptions.js?v=680";
import { createInitialState } from "./state/initialState.js?v=680";
import { applyImportedUiState, exportSavePayloadSnapshot, importSavePayloadText } from "./state/saveLoadActions.js?v=680";
import { playerStats } from "./state/progression.js?v=680";
import { starterTraitStatBonuses } from "./state/starterTraitEffects.js?v=680";
import { addInventoryItem } from "./state/inventory.js";
import { equipInventoryItem, resolveEquipmentSlot, unequipEquipmentSlot } from "./state/equipmentActions.js?v=680";
import { equipRecommendedItems } from "./state/recommendedEquipment.js?v=680";
import {
  beginGateReplay,
  ensureGateProgress as ensureGateProgressState,
  isGateProgressComplete,
  moveGateProgress,
} from "./state/regionProgress.js?v=680";
import {
...
} from "./state/profileActions.js?v=680";
import {
  ...
  saveCurrentToSlot,
  saveSlotLabel,
} from "./state/saveSlots.js?v=680";
import {
  createPendingSlotCreationSnapshot,
  restorePendingSlotCreationSnapshot,
} from "./state/saveSlotSession.js?v=680";

import { createGateNodeResolution, resolveGateNodeOutcome } from "./state/gateNodeActions.js?v=680";
import {
  ...
  stopCombatSession,
  toggleAutoHuntState,
} from "./state/combatSession.js?v=680";
import {
...
} from "./state/passiveRecovery.js?v=680";
import { applyMonsterDefeatRewards } from "./state/combatRewards.js?v=680";
import { applyPendingLevelProgression } from "./state/levelUpActions.js?v=680";
import { applyPlayerDefeatRecovery } from "./state/defeatRecovery.js";
import { recordTutorialBossEvaluation } from "./state/tutorialBossEvaluation.js?v=680";
import {
  advanceDialogueRunAfterDefeat,
  ensureDialogueRunState,
  syncDialogueRunUnlockFlags,
} from "./state/dialogueProgression.js?v=680";
import {
  awardRegressionKarma,
  normalizeKarmaState,
} from "./state/karma.js?v=680";
import { resetWorldProgressForRegression } from "./state/regressionProgression.js?v=680";
import {
  applyRegressionCardSelection,
  createRegressionCardResyncState,
  normalizeRegressionCardState,
} from "./state/regressionCardState.js?v=680";
import {
...
} from "./state/regressionCardDraw.js?v=680";
import { createRegressionFateCardCatalog } from "./state/fateCardPool.js?v=680";
import {
...
} from "./state/hyperActions.js?v=680";
import {
...
} from "./state/combatRuntimeUi.js?v=680";
import {
  BATTLE_SPRITE_MOTION_IDS,
  clearBattleSpriteMotions,
  triggerBattleSpriteMotion,
} from "./ui/battleSpriteMotion.js?v=680";
import {
  monsterAttackEffectPlacement,
  monsterAttackEffectType,
  resolveMonsterBattleSpritePreset,
} from "./config/monsterBattleSpritePresets.js?v=680";
import { resolveMonsterRuntimeAction } from "./config/monsterRuntimeIntegrationPresets.js?v=680";
import { resolvePlayerAttackEffectPlacement } from "./config/playerBattleSprites.js?v=680";
...
import { buyShopItem, sellInventoryItem } from "./state/shop.js?v=680";
import { applyStanceSelection } from "./state/stance.js?v=680";
import {
  allocatePlayerStat,
  ...
  resetAllocatedStats,
} from "./state/statAllocation.js?v=680";
import { applyRegionSelection, previewRegionState } from "./state/regionSelection.js?v=680";
import {
  advanceRegionMonsterEncounter,
  regionMonsterEncounterSeed,
  resolveRegionMonster,
} from "./state/regionMonsterPool.js?v=680";
import {
  stepObjectiveRotationState,
  toggleObjectiveAlertState,
  toggleObjectiveRotationModeState,
} from "./state/objectiveUiState.js?v=680";
import {
...
} from "./story/dialogueEventRuntime.js?v=680";
import { claimOfflineAutoHuntReward, stampLastSeen } from "./state/offlineReward.js?v=680";
import { nodeName } from "./ui/renderRegion.js?v=680";
import { renderLog } from "./ui/renderCommon.js?v=680";
import { renderCombatSkillInfo } from "./ui/renderCombatActions.js?v=680";
import { renderHitCounter } from "./ui/renderCombatPulse.js?v=680";
import { playFateCardRevealMotion } from "./ui/fateCardRevealMotion.js?v=680";
import { setupCollapsiblePanels } from "./ui/panels.js?v=680";
import { setSaveStatus } from "./ui/saveSlotStatus.js?v=680";
import {
  activeViewId,
  activateView,
  resetCharacterCreationWizard,
  setCreationCancelMode,
} from "./ui/viewNavigation.js?v=680";
