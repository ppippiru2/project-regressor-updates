import {
  ...
  HELP_TEXT,
} from "./config/helpText.js?v=366";
import { bindAppEvents } from "./app/appEvents.js?v=366";
import { renderAppFrame, renderAppRegionList } from "./app/appRenderer.js?v=366";
import { handleObjectiveActionNavigation } from "./app/objectiveActionNavigation.js?v=366";
import {
  ACTIVE_SLOT_SYNC_INTERVAL_MS,
  MAX_LOG_LINES,
  OBJECTIVE_TICKER_INTERVAL_MS,
  SLOW_RENDER_INTERVAL_MS,
} from "./app/appRuntimeConfig.js?v=366";
import { finalizeSaveSessionTransition } from "./app/saveSessionFlow.js?v=366";
import { registerServiceWorker } from "./app/serviceWorkerRegistration.js";
import * as assetRegistryApi from "./assets/assetRegistry.js?v=366";
import { applyDomLocalization } from "./localization/domText.js?v=366";
import { t, tf } from "./localization/index.js?v=366";
import { clearCombatEffectLayers } from "./combat/combatEffects.js?v=366";
import { BULK_STAT_DEALLOCATE_AMOUNT } from "./balance/playerGrowthBalance.js?v=366";
import { CONTENT_PROFILE, applyContentProfileToDocument, exposeContentProfile } from "./content/contentProfile.js?v=366";
import {
  clamp,
...
import {
  ...
  stanceName,
} from "./combat/combatActions.js?v=366";
import {
  attackEffectType,
...
import { queueCombatTextEffect } from "./combat/combatFeedbackState.js?v=366";
import { resolveEnemyAttack, resolvePlayerAttack } from "./combat/combatDamage.js";
import { createDefeatedTargetPreview } from "./combat/combatDefeatPreview.js?v=366";
import {
  applyHealAction,
  applyResolvedEnemyAttack,
  applyResolvedPlayerAttack,
} from "./combat/combatActionResults.js?v=366";
import {
  advanceHitCombo,
  applySkillBreakDamage,
  playerHyperChargeFromSuccessfulHit,
  resetHitComboState,
} from "./combat/combatHitResults.js?v=366";
import {
  ...
  createCombatRuntime,
  resetCombatRuntime,
} from "./combat/combatState.js?v=366";
import {
  bossBreakMessage,
  combatStartMessage,
  combatStopMessage,
...
} from "./combat/combatTick.js?v=366";
import { clearIntervalTimer, clearTimeoutTimer, restartIntervalTimer, restartTimeoutTimer } from "./combat/combatTimers.js?v=366";
import {
  applyIncomingDamageTestOption,
  applyOutgoingDamageTestOption,
} from "./combat/combatTestOptions.js?v=366";
import {
  displayNames,
  equipment,
  gateMaps,
...
} from "./state/save.js?v=366";
import {
  developerOptionLabel,
  normalizeDeveloperOptionValue,
  normalizeDeveloperOptions,
} from "./state/developerOptions.js?v=366";
import { createInitialState } from "./state/initialState.js?v=366";
import { applyImportedUiState, exportSavePayloadSnapshot, importSavePayloadText } from "./state/saveLoadActions.js?v=366";
import { playerStats } from "./state/progression.js?v=366";
import { addInventoryItem } from "./state/inventory.js";
import { equipInventoryItem, resolveEquipmentSlot, unequipEquipmentSlot } from "./state/equipmentActions.js?v=366";
import { equipRecommendedItems } from "./state/recommendedEquipment.js?v=366";
import {
  beginGateReplay,
  ensureGateProgress as ensureGateProgressState,
  isGateProgressComplete,
  moveGateProgress,
} from "./state/regionProgress.js?v=366";
import {
  applyCharacterProfile,
  applyInitialCreationStats,
  createCharacterProfile,
  updatePlayerProfileSettings,
} from "./state/profileActions.js?v=366";
import {
  ...
  saveCurrentToSlot,
  saveSlotLabel,
} from "./state/saveSlots.js?v=366";
import {
  createPendingSlotCreationSnapshot,
  restorePendingSlotCreationSnapshot,
} from "./state/saveSlotSession.js?v=366";

import { createGateNodeResolution, resolveGateNodeOutcome } from "./state/gateNodeActions.js?v=366";
import {
  ...
  stopCombatSession,
  toggleAutoHuntState,
} from "./state/combatSession.js?v=366";
import {
...
} from "./state/passiveRecovery.js?v=366";
import { applyMonsterDefeatRewards } from "./state/combatRewards.js?v=366";
import { applyPendingLevelProgression } from "./state/levelUpActions.js?v=366";
...
} from "./state/hyperActions.js?v=366";
import {
...
} from "./state/combatRuntimeUi.js?v=366";
...
import { buyShopItem, sellInventoryItem } from "./state/shop.js?v=366";
import { applyStanceSelection } from "./state/stance.js?v=366";
import {
  allocatePlayerStat,
  ...
  resetAllocatedStats,
} from "./state/statAllocation.js?v=366";
import { applyRegionSelection, previewRegionState } from "./state/regionSelection.js?v=366";
import {
  stepObjectiveRotationState,
  toggleObjectiveAlertState,
  toggleObjectiveRotationModeState,
} from "./state/objectiveUiState.js?v=366";
import {
  ...
  shouldResetHitCombo,
} from "./state/playerResources.js?v=366";
import {
  hasSkillLoadout,
  resolveActiveLoadoutActions,
  resolveActiveLoadoutSkills,
  resolveActiveSkillLoadout,
} from "./state/skillLoadout.js?v=366";
import { claimOfflineAutoHuntReward, stampLastSeen } from "./state/offlineReward.js?v=366";
import { nodeName } from "./ui/renderRegion.js?v=366";
import { renderLog } from "./ui/renderCommon.js?v=366";
import { renderCombatSkillInfo } from "./ui/renderCombatActions.js?v=366";
import { renderHitCounter } from "./ui/renderCombatPulse.js?v=366";
import { setupCollapsiblePanels } from "./ui/panels.js?v=366";
import { setSaveStatus } from "./ui/saveSlotStatus.js?v=366";
import {
  activeViewId,
  activateView,
  resetCharacterCreationWizard,
  setCreationCancelMode,
} from "./ui/viewNavigation.js?v=366";
