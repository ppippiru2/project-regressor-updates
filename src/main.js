import {
  ...
  HELP_TEXT,
} from "./config/helpText.js?v=466";
import { bindAppEvents } from "./app/appEvents.js?v=466";
import { renderAppFrame, renderAppRegionList } from "./app/appRenderer.js?v=466";
import { handleObjectiveActionNavigation } from "./app/objectiveActionNavigation.js?v=466";
import {
  ACTIVE_SLOT_SYNC_INTERVAL_MS,
  MAX_LOG_LINES,
  OBJECTIVE_TICKER_INTERVAL_MS,
  SLOW_RENDER_INTERVAL_MS,
} from "./app/appRuntimeConfig.js?v=466";
import { finalizeSaveSessionTransition } from "./app/saveSessionFlow.js?v=466";
import { registerServiceWorker } from "./app/serviceWorkerRegistration.js";
import * as assetRegistryApi from "./assets/assetRegistry.js?v=466";
import { applyDomLocalization } from "./localization/domText.js?v=466";
import { t, tf } from "./localization/index.js?v=466";
import { clearCombatEffectLayers } from "./combat/combatEffects.js?v=466";
import { BULK_STAT_DEALLOCATE_AMOUNT } from "./balance/playerGrowthBalance.js?v=466";
import { CONTENT_PROFILE, applyContentProfileToDocument, exposeContentProfile } from "./content/contentProfile.js?v=466";
import {
  clamp,
...
import {
  ...
  stanceName,
} from "./combat/combatActions.js?v=466";
import {
  attackEffectType,
...
import { queueCombatTextEffect } from "./combat/combatFeedbackState.js?v=466";
import { resolveEnemyAttack, resolvePlayerAttack } from "./combat/combatDamage.js";
import { createDefeatedTargetPreview } from "./combat/combatDefeatPreview.js?v=466";
import {
  applyHealAction,
  applyResolvedEnemyAttack,
  applyResolvedPlayerAttack,
} from "./combat/combatActionResults.js?v=466";
import {
  advanceHitCombo,
  applySkillBreakDamage,
  playerHyperChargeFromSuccessfulHit,
  resetHitComboState,
} from "./combat/combatHitResults.js?v=466";
import {
  ...
  createCombatRuntime,
  resetCombatRuntime,
} from "./combat/combatState.js?v=466";
import {
  bossBreakMessage,
  combatStartMessage,
  combatStopMessage,
...
} from "./combat/combatTick.js?v=466";
import { clearIntervalTimer, clearTimeoutTimer, restartIntervalTimer, restartTimeoutTimer } from "./combat/combatTimers.js?v=466";
import {
  applyIncomingDamageTestOption,
  applyOutgoingDamageTestOption,
} from "./combat/combatTestOptions.js?v=466";
import {
  displayNames,
  equipment,
  gateMaps,
...
} from "./state/save.js?v=466";
import {
  developerOptionLabel,
  normalizeDeveloperOptionValue,
  normalizeDeveloperOptions,
} from "./state/developerOptions.js?v=466";
import { createInitialState } from "./state/initialState.js?v=466";
import { applyImportedUiState, exportSavePayloadSnapshot, importSavePayloadText } from "./state/saveLoadActions.js?v=466";
import { playerStats } from "./state/progression.js?v=466";
import { starterTraitStatBonuses } from "./state/starterTraitEffects.js?v=466";
import { addInventoryItem } from "./state/inventory.js";
import { equipInventoryItem, resolveEquipmentSlot, unequipEquipmentSlot } from "./state/equipmentActions.js?v=466";
import { equipRecommendedItems } from "./state/recommendedEquipment.js?v=466";
import {
  beginGateReplay,
  ensureGateProgress as ensureGateProgressState,
  isGateProgressComplete,
  moveGateProgress,
} from "./state/regionProgress.js?v=466";
import {
...
} from "./state/profileActions.js?v=466";
import {
  ...
  saveCurrentToSlot,
  saveSlotLabel,
} from "./state/saveSlots.js?v=466";
import {
  createPendingSlotCreationSnapshot,
  restorePendingSlotCreationSnapshot,
} from "./state/saveSlotSession.js?v=466";

import { createGateNodeResolution, resolveGateNodeOutcome } from "./state/gateNodeActions.js?v=466";
import {
  ...
  stopCombatSession,
  toggleAutoHuntState,
} from "./state/combatSession.js?v=466";
import {
...
} from "./state/passiveRecovery.js?v=466";
import { applyMonsterDefeatRewards } from "./state/combatRewards.js?v=466";
import { applyPendingLevelProgression } from "./state/levelUpActions.js?v=466";
...
} from "./state/hyperActions.js?v=466";
import {
...
} from "./state/combatRuntimeUi.js?v=466";
import {
  BATTLE_SPRITE_MOTION_IDS,
  clearBattleSpriteMotions,
  triggerBattleSpriteMotion,
} from "./ui/battleSpriteMotion.js?v=466";
import {
  monsterAttackEffectPlacement,
  monsterAttackEffectType,
  resolveMonsterBattleSpritePreset,
} from "./config/monsterBattleSpritePresets.js?v=466";
import { resolveMonsterRuntimeAction } from "./config/monsterRuntimeIntegrationPresets.js?v=466";
import { resolvePlayerAttackEffectPlacement } from "./config/playerBattleSprites.js?v=466";
...
import { buyShopItem, sellInventoryItem } from "./state/shop.js?v=466";
import { applyStanceSelection } from "./state/stance.js?v=466";
import {
  allocatePlayerStat,
  ...
  resetAllocatedStats,
} from "./state/statAllocation.js?v=466";
import { applyRegionSelection, previewRegionState } from "./state/regionSelection.js?v=466";
import {
  advanceRegionMonsterEncounter,
  regionMonsterEncounterSeed,
  resolveRegionMonster,
} from "./state/regionMonsterPool.js?v=466";
import {
  stepObjectiveRotationState,
  toggleObjectiveAlertState,
  toggleObjectiveRotationModeState,
} from "./state/objectiveUiState.js?v=466";
import {
  ...
  shouldResetHitCombo,
} from "./state/playerResources.js?v=466";
import {
  hasSkillLoadout,
  resolveActiveLoadoutActions,
  resolveActiveLoadoutSkills,
  resolveActiveSkillLoadout,
} from "./state/skillLoadout.js?v=466";
import {
  claimFirstCombatGuide,
  claimRegionCoreEventGuide,
  createTutorialFlags,
} from "./state/tutorialGuidance.js?v=466";
import { claimOfflineAutoHuntReward, stampLastSeen } from "./state/offlineReward.js?v=466";
import { nodeName } from "./ui/renderRegion.js?v=466";
import { renderLog } from "./ui/renderCommon.js?v=466";
import { renderCombatSkillInfo } from "./ui/renderCombatActions.js?v=466";
import { renderHitCounter } from "./ui/renderCombatPulse.js?v=466";
import { setupCollapsiblePanels } from "./ui/panels.js?v=466";
import { setSaveStatus } from "./ui/saveSlotStatus.js?v=466";
import {
  activeViewId,
  activateView,
  resetCharacterCreationWizard,
  setCreationCancelMode,
} from "./ui/viewNavigation.js?v=466";
