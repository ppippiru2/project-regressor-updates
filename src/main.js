import {
  ...
  HELP_TEXT,
} from "./config/helpText.js?v=442";
import { bindAppEvents } from "./app/appEvents.js?v=442";
import { renderAppFrame, renderAppRegionList } from "./app/appRenderer.js?v=442";
import { handleObjectiveActionNavigation } from "./app/objectiveActionNavigation.js?v=442";
import {
  ACTIVE_SLOT_SYNC_INTERVAL_MS,
  MAX_LOG_LINES,
  OBJECTIVE_TICKER_INTERVAL_MS,
  SLOW_RENDER_INTERVAL_MS,
} from "./app/appRuntimeConfig.js?v=442";
import { finalizeSaveSessionTransition } from "./app/saveSessionFlow.js?v=442";
import { registerServiceWorker } from "./app/serviceWorkerRegistration.js";
import * as assetRegistryApi from "./assets/assetRegistry.js?v=442";
import { applyDomLocalization } from "./localization/domText.js?v=442";
import { t, tf } from "./localization/index.js?v=442";
import { clearCombatEffectLayers } from "./combat/combatEffects.js?v=442";
import { BULK_STAT_DEALLOCATE_AMOUNT } from "./balance/playerGrowthBalance.js?v=442";
import { CONTENT_PROFILE, applyContentProfileToDocument, exposeContentProfile } from "./content/contentProfile.js?v=442";
import {
  clamp,
...
import {
  ...
  stanceName,
} from "./combat/combatActions.js?v=442";
import {
  attackEffectType,
...
import { queueCombatTextEffect } from "./combat/combatFeedbackState.js?v=442";
import { resolveEnemyAttack, resolvePlayerAttack } from "./combat/combatDamage.js";
import { createDefeatedTargetPreview } from "./combat/combatDefeatPreview.js?v=442";
import {
  applyHealAction,
  applyResolvedEnemyAttack,
  applyResolvedPlayerAttack,
} from "./combat/combatActionResults.js?v=442";
import {
  advanceHitCombo,
  applySkillBreakDamage,
  playerHyperChargeFromSuccessfulHit,
  resetHitComboState,
} from "./combat/combatHitResults.js?v=442";
import {
  ...
  createCombatRuntime,
  resetCombatRuntime,
} from "./combat/combatState.js?v=442";
import {
  bossBreakMessage,
  combatStartMessage,
  combatStopMessage,
...
} from "./combat/combatTick.js?v=442";
import { clearIntervalTimer, clearTimeoutTimer, restartIntervalTimer, restartTimeoutTimer } from "./combat/combatTimers.js?v=442";
import {
  applyIncomingDamageTestOption,
  applyOutgoingDamageTestOption,
} from "./combat/combatTestOptions.js?v=442";
import {
  displayNames,
  equipment,
  gateMaps,
...
} from "./state/save.js?v=442";
import {
  developerOptionLabel,
  normalizeDeveloperOptionValue,
  normalizeDeveloperOptions,
} from "./state/developerOptions.js?v=442";
import { createInitialState } from "./state/initialState.js?v=442";
import { applyImportedUiState, exportSavePayloadSnapshot, importSavePayloadText } from "./state/saveLoadActions.js?v=442";
import { playerStats } from "./state/progression.js?v=442";
import { starterTraitStatBonuses } from "./state/starterTraitEffects.js?v=442";
import { addInventoryItem } from "./state/inventory.js";
import { equipInventoryItem, resolveEquipmentSlot, unequipEquipmentSlot } from "./state/equipmentActions.js?v=442";
import { equipRecommendedItems } from "./state/recommendedEquipment.js?v=442";
import {
  beginGateReplay,
  ensureGateProgress as ensureGateProgressState,
  isGateProgressComplete,
  moveGateProgress,
} from "./state/regionProgress.js?v=442";
import {
...
} from "./state/profileActions.js?v=442";
import {
  ...
  saveCurrentToSlot,
  saveSlotLabel,
} from "./state/saveSlots.js?v=442";
import {
  createPendingSlotCreationSnapshot,
  restorePendingSlotCreationSnapshot,
} from "./state/saveSlotSession.js?v=442";

import { createGateNodeResolution, resolveGateNodeOutcome } from "./state/gateNodeActions.js?v=442";
import {
  ...
  stopCombatSession,
  toggleAutoHuntState,
} from "./state/combatSession.js?v=442";
import {
...
} from "./state/passiveRecovery.js?v=442";
import { applyMonsterDefeatRewards } from "./state/combatRewards.js?v=442";
import { applyPendingLevelProgression } from "./state/levelUpActions.js?v=442";
...
} from "./state/hyperActions.js?v=442";
import {
...
} from "./state/combatRuntimeUi.js?v=442";
import {
  BATTLE_SPRITE_MOTION_IDS,
  clearBattleSpriteMotions,
  triggerBattleSpriteMotion,
} from "./ui/battleSpriteMotion.js?v=442";
import {
  monsterAttackEffectPlacement,
  monsterAttackEffectType,
  resolveMonsterBattleSpritePreset,
} from "./config/monsterBattleSpritePresets.js?v=442";
import { resolvePlayerAttackEffectPlacement } from "./config/playerBattleSprites.js?v=442";
...
import { buyShopItem, sellInventoryItem } from "./state/shop.js?v=442";
import { applyStanceSelection } from "./state/stance.js?v=442";
import {
  allocatePlayerStat,
  ...
  resetAllocatedStats,
} from "./state/statAllocation.js?v=442";
import { applyRegionSelection, previewRegionState } from "./state/regionSelection.js?v=442";
import {
  advanceRegionMonsterEncounter,
  regionMonsterEncounterSeed,
  resolveRegionMonster,
} from "./state/regionMonsterPool.js?v=442";
import {
  stepObjectiveRotationState,
  toggleObjectiveAlertState,
  toggleObjectiveRotationModeState,
} from "./state/objectiveUiState.js?v=442";
import {
  ...
  shouldResetHitCombo,
} from "./state/playerResources.js?v=442";
import {
  hasSkillLoadout,
  resolveActiveLoadoutActions,
  resolveActiveLoadoutSkills,
  resolveActiveSkillLoadout,
} from "./state/skillLoadout.js?v=442";
import {
  claimFirstCombatGuide,
  claimRegionCoreEventGuide,
  createTutorialFlags,
} from "./state/tutorialGuidance.js?v=442";
import { claimOfflineAutoHuntReward, stampLastSeen } from "./state/offlineReward.js?v=442";
import { nodeName } from "./ui/renderRegion.js?v=442";
import { renderLog } from "./ui/renderCommon.js?v=442";
import { renderCombatSkillInfo } from "./ui/renderCombatActions.js?v=442";
import { renderHitCounter } from "./ui/renderCombatPulse.js?v=442";
import { setupCollapsiblePanels } from "./ui/panels.js?v=442";
import { setSaveStatus } from "./ui/saveSlotStatus.js?v=442";
import {
  activeViewId,
  activateView,
  resetCharacterCreationWizard,
  setCreationCancelMode,
} from "./ui/viewNavigation.js?v=442";
