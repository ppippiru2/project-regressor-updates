import {
  ...
  HELP_TEXT,
} from "./config/helpText.js?v=408";
import { bindAppEvents } from "./app/appEvents.js?v=408";
import { renderAppFrame, renderAppRegionList } from "./app/appRenderer.js?v=408";
import { handleObjectiveActionNavigation } from "./app/objectiveActionNavigation.js?v=408";
import {
  ACTIVE_SLOT_SYNC_INTERVAL_MS,
  MAX_LOG_LINES,
  OBJECTIVE_TICKER_INTERVAL_MS,
  SLOW_RENDER_INTERVAL_MS,
} from "./app/appRuntimeConfig.js?v=408";
import { finalizeSaveSessionTransition } from "./app/saveSessionFlow.js?v=408";
import { registerServiceWorker } from "./app/serviceWorkerRegistration.js";
import * as assetRegistryApi from "./assets/assetRegistry.js?v=408";
import { applyDomLocalization } from "./localization/domText.js?v=408";
import { t, tf } from "./localization/index.js?v=408";
import { clearCombatEffectLayers } from "./combat/combatEffects.js?v=408";
import { BULK_STAT_DEALLOCATE_AMOUNT } from "./balance/playerGrowthBalance.js?v=408";
import { CONTENT_PROFILE, applyContentProfileToDocument, exposeContentProfile } from "./content/contentProfile.js?v=408";
import {
  clamp,
...
import {
  ...
  stanceName,
} from "./combat/combatActions.js?v=408";
import {
  attackEffectType,
...
import { queueCombatTextEffect } from "./combat/combatFeedbackState.js?v=408";
import { resolveEnemyAttack, resolvePlayerAttack } from "./combat/combatDamage.js";
import { createDefeatedTargetPreview } from "./combat/combatDefeatPreview.js?v=408";
import {
  applyHealAction,
  applyResolvedEnemyAttack,
  applyResolvedPlayerAttack,
} from "./combat/combatActionResults.js?v=408";
import {
  advanceHitCombo,
  applySkillBreakDamage,
  playerHyperChargeFromSuccessfulHit,
  resetHitComboState,
} from "./combat/combatHitResults.js?v=408";
import {
  ...
  createCombatRuntime,
  resetCombatRuntime,
} from "./combat/combatState.js?v=408";
import {
  bossBreakMessage,
  combatStartMessage,
  combatStopMessage,
...
} from "./combat/combatTick.js?v=408";
import { clearIntervalTimer, clearTimeoutTimer, restartIntervalTimer, restartTimeoutTimer } from "./combat/combatTimers.js?v=408";
import {
  applyIncomingDamageTestOption,
  applyOutgoingDamageTestOption,
} from "./combat/combatTestOptions.js?v=408";
import {
  displayNames,
  equipment,
  gateMaps,
...
} from "./state/save.js?v=408";
import {
  developerOptionLabel,
  normalizeDeveloperOptionValue,
  normalizeDeveloperOptions,
} from "./state/developerOptions.js?v=408";
import { createInitialState } from "./state/initialState.js?v=408";
import { applyImportedUiState, exportSavePayloadSnapshot, importSavePayloadText } from "./state/saveLoadActions.js?v=408";
import { playerStats } from "./state/progression.js?v=408";
import { starterTraitStatBonuses } from "./state/starterTraitEffects.js?v=408";
import { addInventoryItem } from "./state/inventory.js";
import { equipInventoryItem, resolveEquipmentSlot, unequipEquipmentSlot } from "./state/equipmentActions.js?v=408";
import { equipRecommendedItems } from "./state/recommendedEquipment.js?v=408";
import {
  beginGateReplay,
  ensureGateProgress as ensureGateProgressState,
  isGateProgressComplete,
  moveGateProgress,
} from "./state/regionProgress.js?v=408";
import {
...
} from "./state/profileActions.js?v=408";
import {
  ...
  saveCurrentToSlot,
  saveSlotLabel,
} from "./state/saveSlots.js?v=408";
import {
  createPendingSlotCreationSnapshot,
  restorePendingSlotCreationSnapshot,
} from "./state/saveSlotSession.js?v=408";

import { createGateNodeResolution, resolveGateNodeOutcome } from "./state/gateNodeActions.js?v=408";
import {
  ...
  stopCombatSession,
  toggleAutoHuntState,
} from "./state/combatSession.js?v=408";
import {
...
} from "./state/passiveRecovery.js?v=408";
import { applyMonsterDefeatRewards } from "./state/combatRewards.js?v=408";
import { applyPendingLevelProgression } from "./state/levelUpActions.js?v=408";
...
} from "./state/hyperActions.js?v=408";
import {
...
} from "./state/combatRuntimeUi.js?v=408";
import {
  BATTLE_SPRITE_MOTION_IDS,
  clearBattleSpriteMotions,
  triggerBattleSpriteMotion,
} from "./ui/battleSpriteMotion.js?v=408";
import {
  monsterAttackEffectPlacement,
  monsterAttackEffectType,
  resolveMonsterBattleSpritePreset,
} from "./config/monsterBattleSpritePresets.js?v=408";
import { resolvePlayerAttackEffectPlacement } from "./config/playerBattleSprites.js?v=408";
...
import { buyShopItem, sellInventoryItem } from "./state/shop.js?v=408";
import { applyStanceSelection } from "./state/stance.js?v=408";
import {
  allocatePlayerStat,
  ...
  resetAllocatedStats,
} from "./state/statAllocation.js?v=408";
import { applyRegionSelection, previewRegionState } from "./state/regionSelection.js?v=408";
import {
  stepObjectiveRotationState,
  toggleObjectiveAlertState,
  toggleObjectiveRotationModeState,
} from "./state/objectiveUiState.js?v=408";
import {
  ...
  shouldResetHitCombo,
} from "./state/playerResources.js?v=408";
import {
  hasSkillLoadout,
  resolveActiveLoadoutActions,
  resolveActiveLoadoutSkills,
  resolveActiveSkillLoadout,
} from "./state/skillLoadout.js?v=408";
import { claimFirstCombatGuide, createTutorialFlags } from "./state/tutorialGuidance.js?v=408";
import { claimOfflineAutoHuntReward, stampLastSeen } from "./state/offlineReward.js?v=408";
import { nodeName } from "./ui/renderRegion.js?v=408";
import { renderLog } from "./ui/renderCommon.js?v=408";
import { renderCombatSkillInfo } from "./ui/renderCombatActions.js?v=408";
import { renderHitCounter } from "./ui/renderCombatPulse.js?v=408";
import { setupCollapsiblePanels } from "./ui/panels.js?v=408";
import { setSaveStatus } from "./ui/saveSlotStatus.js?v=408";
import {
  activeViewId,
  activateView,
  resetCharacterCreationWizard,
  setCreationCancelMode,
} from "./ui/viewNavigation.js?v=408";
