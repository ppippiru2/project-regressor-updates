import {
  ...
  HELP_TEXT,
} from "./config/helpText.js?v=502";
import { bindAppEvents } from "./app/appEvents.js?v=502";
import { renderAppFrame, renderAppRegionList } from "./app/appRenderer.js?v=502";
import { handleObjectiveActionNavigation } from "./app/objectiveActionNavigation.js?v=502";
import {
  ACTIVE_SLOT_SYNC_INTERVAL_MS,
  MAX_LOG_LINES,
  OBJECTIVE_TICKER_INTERVAL_MS,
  SLOW_RENDER_INTERVAL_MS,
} from "./app/appRuntimeConfig.js?v=502";
import { finalizeSaveSessionTransition } from "./app/saveSessionFlow.js?v=502";
import { registerServiceWorker } from "./app/serviceWorkerRegistration.js";
import * as assetRegistryApi from "./assets/assetRegistry.js?v=502";
import { applyDomLocalization } from "./localization/domText.js?v=502";
import { t, tf } from "./localization/index.js?v=502";
import { clearCombatEffectLayers } from "./combat/combatEffects.js?v=502";
import { BULK_STAT_DEALLOCATE_AMOUNT } from "./balance/playerGrowthBalance.js?v=502";
import { CONTENT_PROFILE, applyContentProfileToDocument, exposeContentProfile } from "./content/contentProfile.js?v=502";
import {
  clamp,
...
import {
  ...
  stanceName,
} from "./combat/combatActions.js?v=502";
import {
  attackEffectType,
...
import { queueCombatTextEffect } from "./combat/combatFeedbackState.js?v=502";
import { resolveEnemyAttack, resolvePlayerAttack } from "./combat/combatDamage.js";
import { createDefeatedTargetPreview } from "./combat/combatDefeatPreview.js?v=502";
import {
  applyHealAction,
  applyResolvedEnemyAttack,
  applyResolvedPlayerAttack,
} from "./combat/combatActionResults.js?v=502";
import {
  ...
  resetHitComboState,
} from "./combat/combatHitResults.js?v=502";
import {
  ...
  createCombatRuntime,
  resetCombatRuntime,
} from "./combat/combatState.js?v=502";
import {
  bossBreakMessage,
  combatStartMessage,
  combatStopMessage,
...
} from "./combat/combatTick.js?v=502";
import { clearIntervalTimer, clearTimeoutTimer, restartIntervalTimer, restartTimeoutTimer } from "./combat/combatTimers.js?v=502";
import {
  applyIncomingDamageTestOption,
  applyOutgoingDamageTestOption,
} from "./combat/combatTestOptions.js?v=502";
import {
  displayNames,
  equipment,
  gateMaps,
...
} from "./state/save.js?v=502";
import {
  developerOptionLabel,
  normalizeDeveloperOptionValue,
  normalizeDeveloperOptions,
} from "./state/developerOptions.js?v=502";
import { createInitialState } from "./state/initialState.js?v=502";
import { applyImportedUiState, exportSavePayloadSnapshot, importSavePayloadText } from "./state/saveLoadActions.js?v=502";
import { playerStats } from "./state/progression.js?v=502";
import { starterTraitStatBonuses } from "./state/starterTraitEffects.js?v=502";
import { addInventoryItem } from "./state/inventory.js";
import { equipInventoryItem, resolveEquipmentSlot, unequipEquipmentSlot } from "./state/equipmentActions.js?v=502";
import { equipRecommendedItems } from "./state/recommendedEquipment.js?v=502";
import {
  beginGateReplay,
  ensureGateProgress as ensureGateProgressState,
  isGateProgressComplete,
  moveGateProgress,
} from "./state/regionProgress.js?v=502";
import {
...
} from "./state/profileActions.js?v=502";
import {
  ...
  saveCurrentToSlot,
  saveSlotLabel,
} from "./state/saveSlots.js?v=502";
import {
  createPendingSlotCreationSnapshot,
  restorePendingSlotCreationSnapshot,
} from "./state/saveSlotSession.js?v=502";

import { createGateNodeResolution, resolveGateNodeOutcome } from "./state/gateNodeActions.js?v=502";
import {
  ...
  stopCombatSession,
  toggleAutoHuntState,
} from "./state/combatSession.js?v=502";
import {
...
} from "./state/passiveRecovery.js?v=502";
import { applyMonsterDefeatRewards } from "./state/combatRewards.js?v=502";
import { applyPendingLevelProgression } from "./state/levelUpActions.js?v=502";
...
} from "./state/hyperActions.js?v=502";
import {
...
import { resolveMonsterRuntimeAction } from "./config/monsterRuntimeIntegrationPresets.js?v=502";
import { resolvePlayerAttackEffectPlacement } from "./config/playerBattleSprites.js?v=502";
...
import { buyShopItem, sellInventoryItem } from "./state/shop.js?v=502";
import { applyStanceSelection } from "./state/stance.js?v=502";
import {
  allocatePlayerStat,
  ...
  resetAllocatedStats,
} from "./state/statAllocation.js?v=502";
import { applyRegionSelection, previewRegionState } from "./state/regionSelection.js?v=502";
import {
  advanceRegionMonsterEncounter,
  regionMonsterEncounterSeed,
  resolveRegionMonster,
} from "./state/regionMonsterPool.js?v=502";
import {
  stepObjectiveRotationState,
  toggleObjectiveAlertState,
  toggleObjectiveRotationModeState,
} from "./state/objectiveUiState.js?v=502";
import {
  ...
  shouldResetHitCombo,
} from "./state/playerResources.js?v=502";
import {
  hasSkillLoadout,
  resolveActiveLoadoutActions,
  resolveActiveLoadoutSkills,
  resolveActiveSkillLoadout,
} from "./state/skillLoadout.js?v=502";
import {
  claimFirstCombatGuide,
  claimRegionCoreEventGuide,
  createTutorialFlags,
} from "./state/tutorialGuidance.js?v=502";
import { claimOfflineAutoHuntReward, stampLastSeen } from "./state/offlineReward.js?v=502";
import { nodeName } from "./ui/renderRegion.js?v=502";
import { renderLog } from "./ui/renderCommon.js?v=502";
import { renderCombatSkillInfo } from "./ui/renderCombatActions.js?v=502";
import { renderHitCounter } from "./ui/renderCombatPulse.js?v=502";
import { setupCollapsiblePanels } from "./ui/panels.js?v=502";
import { setSaveStatus } from "./ui/saveSlotStatus.js?v=502";
import {
  activeViewId,
  activateView,
  resetCharacterCreationWizard,
  setCreationCancelMode,
} from "./ui/viewNavigation.js?v=502";
