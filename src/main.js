import {
  ...
  HELP_TEXT,
} from "./config/helpText.js?v=362";
import { bindAppEvents } from "./app/appEvents.js?v=362";
import { renderAppFrame, renderAppRegionList } from "./app/appRenderer.js?v=362";
import { handleObjectiveActionNavigation } from "./app/objectiveActionNavigation.js?v=362";
import {
  ACTIVE_SLOT_SYNC_INTERVAL_MS,
  MAX_LOG_LINES,
  OBJECTIVE_TICKER_INTERVAL_MS,
  SLOW_RENDER_INTERVAL_MS,
} from "./app/appRuntimeConfig.js?v=362";
import { finalizeSaveSessionTransition } from "./app/saveSessionFlow.js?v=362";
import { registerServiceWorker } from "./app/serviceWorkerRegistration.js";
import * as assetRegistryApi from "./assets/assetRegistry.js?v=362";
import { applyDomLocalization } from "./localization/domText.js?v=362";
import { t, tf } from "./localization/index.js?v=362";
import { clearCombatEffectLayers } from "./combat/combatEffects.js?v=362";
import { BULK_STAT_DEALLOCATE_AMOUNT } from "./balance/playerGrowthBalance.js?v=362";
import { CONTENT_PROFILE, applyContentProfileToDocument, exposeContentProfile } from "./content/contentProfile.js?v=362";
import {
  clamp,
...
import {
  ...
  stanceName,
} from "./combat/combatActions.js?v=362";
import {
  attackEffectType,
...
import { queueCombatTextEffect } from "./combat/combatFeedbackState.js?v=362";
import { resolveEnemyAttack, resolvePlayerAttack } from "./combat/combatDamage.js";
import { createDefeatedTargetPreview } from "./combat/combatDefeatPreview.js?v=362";
import {
  applyHealAction,
  applyResolvedEnemyAttack,
  applyResolvedPlayerAttack,
} from "./combat/combatActionResults.js?v=362";
import {
  advanceHitCombo,
  applySkillBreakDamage,
  playerHyperChargeFromSuccessfulHit,
  resetHitComboState,
} from "./combat/combatHitResults.js?v=362";
import {
  ...
  createCombatRuntime,
  resetCombatRuntime,
} from "./combat/combatState.js?v=362";
import {
  bossBreakMessage,
  combatStartMessage,
  combatStopMessage,
...
} from "./combat/combatTick.js?v=362";
import { clearIntervalTimer, clearTimeoutTimer, restartIntervalTimer, restartTimeoutTimer } from "./combat/combatTimers.js?v=362";
import {
  applyIncomingDamageTestOption,
  applyOutgoingDamageTestOption,
} from "./combat/combatTestOptions.js?v=362";
import {
  displayNames,
  equipment,
  gateMaps,
...
} from "./state/save.js?v=362";
import {
  developerOptionLabel,
  normalizeDeveloperOptionValue,
  normalizeDeveloperOptions,
} from "./state/developerOptions.js?v=362";
import { createInitialState } from "./state/initialState.js?v=362";
import { applyImportedUiState, exportSavePayloadSnapshot, importSavePayloadText } from "./state/saveLoadActions.js?v=362";
import { playerStats } from "./state/progression.js?v=362";
import { addInventoryItem } from "./state/inventory.js";
import { equipInventoryItem, resolveEquipmentSlot, unequipEquipmentSlot } from "./state/equipmentActions.js?v=362";
import { equipRecommendedItems } from "./state/recommendedEquipment.js?v=362";
import {
  beginGateReplay,
  ensureGateProgress as ensureGateProgressState,
  isGateProgressComplete,
  moveGateProgress,
} from "./state/regionProgress.js?v=362";
import {
  applyCharacterProfile,
  applyInitialCreationStats,
  createCharacterProfile,
  updatePlayerProfileSettings,
} from "./state/profileActions.js?v=362";
import {
  ...
  saveCurrentToSlot,
  saveSlotLabel,
} from "./state/saveSlots.js?v=362";
import {
  createPendingSlotCreationSnapshot,
  restorePendingSlotCreationSnapshot,
} from "./state/saveSlotSession.js?v=362";

import { createGateNodeResolution, resolveGateNodeOutcome } from "./state/gateNodeActions.js?v=362";
import {
  ...
  stopCombatSession,
  toggleAutoHuntState,
} from "./state/combatSession.js?v=362";
import {
...
} from "./state/passiveRecovery.js?v=362";
import { applyMonsterDefeatRewards } from "./state/combatRewards.js?v=362";
import { applyPendingLevelProgression } from "./state/levelUpActions.js?v=362";
...
} from "./state/hyperActions.js?v=362";
import {
...
} from "./state/combatRuntimeUi.js?v=362";
...
import { buyShopItem, sellInventoryItem } from "./state/shop.js?v=362";
import { applyStanceSelection } from "./state/stance.js?v=362";
import {
  allocatePlayerStat,
  ...
  resetAllocatedStats,
} from "./state/statAllocation.js?v=362";
import { applyRegionSelection, previewRegionState } from "./state/regionSelection.js?v=362";
import {
  stepObjectiveRotationState,
  toggleObjectiveAlertState,
  toggleObjectiveRotationModeState,
} from "./state/objectiveUiState.js?v=362";
import {
  ...
  shouldResetHitCombo,
} from "./state/playerResources.js?v=362";
import {
  hasSkillLoadout,
  resolveActiveLoadoutActions,
  resolveActiveLoadoutSkills,
  resolveActiveSkillLoadout,
} from "./state/skillLoadout.js?v=362";
import { claimOfflineAutoHuntReward, stampLastSeen } from "./state/offlineReward.js?v=362";
import { nodeName } from "./ui/renderRegion.js?v=362";
import { renderLog } from "./ui/renderCommon.js?v=362";
import { renderCombatSkillInfo } from "./ui/renderCombatActions.js?v=362";
import { renderHitCounter } from "./ui/renderCombatPulse.js?v=362";
import { setupCollapsiblePanels } from "./ui/panels.js?v=362";
import { setSaveStatus } from "./ui/saveSlotStatus.js?v=362";
import {
  activeViewId,
  activateView,
  resetCharacterCreationWizard,
  setCreationCancelMode,
} from "./ui/viewNavigation.js?v=362";
