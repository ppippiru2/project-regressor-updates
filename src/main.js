import {
  ...
  HELP_TEXT,
} from "./config/helpText.js?v=479";
import { bindAppEvents } from "./app/appEvents.js?v=479";
import { renderAppFrame, renderAppRegionList } from "./app/appRenderer.js?v=479";
import { handleObjectiveActionNavigation } from "./app/objectiveActionNavigation.js?v=479";
import {
  ACTIVE_SLOT_SYNC_INTERVAL_MS,
  MAX_LOG_LINES,
  OBJECTIVE_TICKER_INTERVAL_MS,
  SLOW_RENDER_INTERVAL_MS,
} from "./app/appRuntimeConfig.js?v=479";
import { finalizeSaveSessionTransition } from "./app/saveSessionFlow.js?v=479";
import { registerServiceWorker } from "./app/serviceWorkerRegistration.js";
import * as assetRegistryApi from "./assets/assetRegistry.js?v=479";
import { applyDomLocalization } from "./localization/domText.js?v=479";
import { t, tf } from "./localization/index.js?v=479";
import { clearCombatEffectLayers } from "./combat/combatEffects.js?v=479";
import { BULK_STAT_DEALLOCATE_AMOUNT } from "./balance/playerGrowthBalance.js?v=479";
import { CONTENT_PROFILE, applyContentProfileToDocument, exposeContentProfile } from "./content/contentProfile.js?v=479";
import {
  clamp,
...
import {
  ...
  stanceName,
} from "./combat/combatActions.js?v=479";
import {
  attackEffectType,
...
import { queueCombatTextEffect } from "./combat/combatFeedbackState.js?v=479";
import { resolveEnemyAttack, resolvePlayerAttack } from "./combat/combatDamage.js";
import { createDefeatedTargetPreview } from "./combat/combatDefeatPreview.js?v=479";
import {
  applyHealAction,
  applyResolvedEnemyAttack,
  applyResolvedPlayerAttack,
} from "./combat/combatActionResults.js?v=479";
import {
  advanceHitCombo,
  applySkillBreakDamage,
  playerHyperChargeFromSuccessfulHit,
  resetHitComboState,
} from "./combat/combatHitResults.js?v=479";
import {
  ...
  createCombatRuntime,
  resetCombatRuntime,
} from "./combat/combatState.js?v=479";
import {
  bossBreakMessage,
  combatStartMessage,
  combatStopMessage,
...
} from "./combat/combatTick.js?v=479";
import { clearIntervalTimer, clearTimeoutTimer, restartIntervalTimer, restartTimeoutTimer } from "./combat/combatTimers.js?v=479";
import {
  applyIncomingDamageTestOption,
  applyOutgoingDamageTestOption,
} from "./combat/combatTestOptions.js?v=479";
import {
  displayNames,
  equipment,
  gateMaps,
...
} from "./state/save.js?v=479";
import {
  developerOptionLabel,
  normalizeDeveloperOptionValue,
  normalizeDeveloperOptions,
} from "./state/developerOptions.js?v=479";
import { createInitialState } from "./state/initialState.js?v=479";
import { applyImportedUiState, exportSavePayloadSnapshot, importSavePayloadText } from "./state/saveLoadActions.js?v=479";
import { playerStats } from "./state/progression.js?v=479";
import { starterTraitStatBonuses } from "./state/starterTraitEffects.js?v=479";
import { addInventoryItem } from "./state/inventory.js";
import { equipInventoryItem, resolveEquipmentSlot, unequipEquipmentSlot } from "./state/equipmentActions.js?v=479";
import { equipRecommendedItems } from "./state/recommendedEquipment.js?v=479";
import {
  beginGateReplay,
  ensureGateProgress as ensureGateProgressState,
  isGateProgressComplete,
  moveGateProgress,
} from "./state/regionProgress.js?v=479";
import {
...
} from "./state/profileActions.js?v=479";
import {
  ...
  saveCurrentToSlot,
  saveSlotLabel,
} from "./state/saveSlots.js?v=479";
import {
  createPendingSlotCreationSnapshot,
  restorePendingSlotCreationSnapshot,
} from "./state/saveSlotSession.js?v=479";

import { createGateNodeResolution, resolveGateNodeOutcome } from "./state/gateNodeActions.js?v=479";
import {
  ...
  stopCombatSession,
  toggleAutoHuntState,
} from "./state/combatSession.js?v=479";
import {
...
} from "./state/passiveRecovery.js?v=479";
import { applyMonsterDefeatRewards } from "./state/combatRewards.js?v=479";
import { applyPendingLevelProgression } from "./state/levelUpActions.js?v=479";
...
} from "./state/hyperActions.js?v=479";
import {
...
} from "./state/combatRuntimeUi.js?v=479";
import {
  BATTLE_SPRITE_MOTION_IDS,
  clearBattleSpriteMotions,
  triggerBattleSpriteMotion,
} from "./ui/battleSpriteMotion.js?v=479";
import {
  monsterAttackEffectPlacement,
  monsterAttackEffectType,
  resolveMonsterBattleSpritePreset,
} from "./config/monsterBattleSpritePresets.js?v=479";
import { resolveMonsterRuntimeAction } from "./config/monsterRuntimeIntegrationPresets.js?v=479";
import { resolvePlayerAttackEffectPlacement } from "./config/playerBattleSprites.js?v=479";
...
import { buyShopItem, sellInventoryItem } from "./state/shop.js?v=479";
import { applyStanceSelection } from "./state/stance.js?v=479";
import {
  allocatePlayerStat,
  ...
  resetAllocatedStats,
} from "./state/statAllocation.js?v=479";
import { applyRegionSelection, previewRegionState } from "./state/regionSelection.js?v=479";
import {
  advanceRegionMonsterEncounter,
  regionMonsterEncounterSeed,
  resolveRegionMonster,
} from "./state/regionMonsterPool.js?v=479";
import {
  stepObjectiveRotationState,
  toggleObjectiveAlertState,
  toggleObjectiveRotationModeState,
} from "./state/objectiveUiState.js?v=479";
import {
  ...
  shouldResetHitCombo,
} from "./state/playerResources.js?v=479";
import {
  hasSkillLoadout,
  resolveActiveLoadoutActions,
  resolveActiveLoadoutSkills,
  resolveActiveSkillLoadout,
} from "./state/skillLoadout.js?v=479";
import {
  claimFirstCombatGuide,
  claimRegionCoreEventGuide,
  createTutorialFlags,
} from "./state/tutorialGuidance.js?v=479";
import { claimOfflineAutoHuntReward, stampLastSeen } from "./state/offlineReward.js?v=479";
import { nodeName } from "./ui/renderRegion.js?v=479";
import { renderLog } from "./ui/renderCommon.js?v=479";
import { renderCombatSkillInfo } from "./ui/renderCombatActions.js?v=479";
import { renderHitCounter } from "./ui/renderCombatPulse.js?v=479";
import { setupCollapsiblePanels } from "./ui/panels.js?v=479";
import { setSaveStatus } from "./ui/saveSlotStatus.js?v=479";
import {
  activeViewId,
  activateView,
  resetCharacterCreationWizard,
  setCreationCancelMode,
} from "./ui/viewNavigation.js?v=479";
