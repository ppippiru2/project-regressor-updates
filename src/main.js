import {
  ...
  HELP_TEXT,
} from "./config/helpText.js?v=681";
import { bindAppEvents } from "./app/appEvents.js?v=681";
import { createAppRenderContext, createCombatActionRenderContext } from "./app/appRenderContextFactory.js?v=681";
import { renderAppFrame, renderAppRegionList } from "./app/appRenderer.js?v=681";
import { handleObjectiveActionNavigation } from "./app/objectiveActionNavigation.js?v=681";
import {
  ACTIVE_SLOT_SYNC_INTERVAL_MS,
  MAX_LOG_LINES,
  OBJECTIVE_TICKER_INTERVAL_MS,
  SLOW_RENDER_INTERVAL_MS,
} from "./app/appRuntimeConfig.js?v=681";
import { finalizeSaveSessionTransition } from "./app/saveSessionFlow.js?v=681";
import { registerServiceWorker } from "./app/serviceWorkerRegistration.js";
import * as assetRegistryApi from "./assets/assetRegistry.js?v=681";
import { applyDomLocalization } from "./localization/domText.js?v=681";
import { getLocaleText, t, tf } from "./localization/index.js?v=681";
import { clearCombatEffectLayers } from "./combat/combatEffects.js?v=681";
import { BULK_STAT_DEALLOCATE_AMOUNT } from "./balance/playerGrowthBalance.js?v=681";
import { CONTENT_PROFILE, applyContentProfileToDocument, exposeContentProfile } from "./content/contentProfile.js?v=681";
import {
  clamp,
...
import {
  ...
  stanceName,
} from "./combat/combatActions.js?v=681";
import {
  attackEffectType,
...
import { queueCombatTextEffect } from "./combat/combatFeedbackState.js?v=681";
import { resolveEnemyAttack, resolvePlayerAttack } from "./combat/combatDamage.js";
import { createDefeatedTargetPreview } from "./combat/combatDefeatPreview.js?v=681";
import {
  applyBuffAction,
  applyHealAction,
  applyResolvedEnemyAttack,
  applyResolvedPlayerAttack,
} from "./combat/combatActionResults.js?v=681";
import {
  ...
  resetHitComboState,
} from "./combat/combatHitResults.js?v=681";
import {
  ...
  createCombatRuntime,
  resetCombatRuntime,
} from "./combat/combatState.js?v=681";
import { isCombatStyleAction, isCombatStyleActive } from "./combat/combatStyleActions.js?v=681";
import {
  bossBreakMessage,
  combatStartMessage,
  combatStopMessage,
...
} from "./combat/combatTick.js?v=681";
import { clearIntervalTimer, clearTimeoutTimer, restartIntervalTimer, restartTimeoutTimer } from "./combat/combatTimers.js?v=681";
import {
  applyIncomingDamageTestOption,
  applyOutgoingDamageTestOption,
} from "./combat/combatTestOptions.js?v=681";
import {
  displayNames,
  equipment,
  gateMaps,
...
} from "./state/save.js?v=681";
import {
  developerOptionLabel,
  normalizeDeveloperOptionValue,
  normalizeDeveloperOptions,
} from "./state/developerOptions.js?v=681";
import { createInitialState } from "./state/initialState.js?v=681";
import { applyImportedUiState, exportSavePayloadSnapshot, importSavePayloadText } from "./state/saveLoadActions.js?v=681";
import { playerStats } from "./state/progression.js?v=681";
import { starterTraitStatBonuses } from "./state/starterTraitEffects.js?v=681";
import { addInventoryItem } from "./state/inventory.js";
import { equipInventoryItem, resolveEquipmentSlot, unequipEquipmentSlot } from "./state/equipmentActions.js?v=681";
import { equipRecommendedItems } from "./state/recommendedEquipment.js?v=681";
import {
  beginGateReplay,
  ensureGateProgress as ensureGateProgressState,
  isGateProgressComplete,
  moveGateProgress,
} from "./state/regionProgress.js?v=681";
import {
...
} from "./state/profileActions.js?v=681";
import {
  ...
  saveCurrentToSlot,
  saveSlotLabel,
} from "./state/saveSlots.js?v=681";
import {
  createPendingSlotCreationSnapshot,
  restorePendingSlotCreationSnapshot,
} from "./state/saveSlotSession.js?v=681";

import { createGateNodeResolution, resolveGateNodeOutcome } from "./state/gateNodeActions.js?v=681";
import {
  ...
  stopCombatSession,
  toggleAutoHuntState,
} from "./state/combatSession.js?v=681";
import {
...
} from "./state/passiveRecovery.js?v=681";
import { applyMonsterDefeatRewards } from "./state/combatRewards.js?v=681";
import { applyPendingLevelProgression } from "./state/levelUpActions.js?v=681";
import { applyPlayerDefeatRecovery } from "./state/defeatRecovery.js";
import { recordTutorialBossEvaluation } from "./state/tutorialBossEvaluation.js?v=681";
import {
  advanceDialogueRunAfterDefeat,
  ensureDialogueRunState,
  syncDialogueRunUnlockFlags,
} from "./state/dialogueProgression.js?v=681";
import {
  awardRegressionKarma,
  normalizeKarmaState,
} from "./state/karma.js?v=681";
import { resetWorldProgressForRegression } from "./state/regressionProgression.js?v=681";
import {
...
} from "./state/regressionCardDraw.js?v=681";
...
} from "./state/hyperActions.js?v=681";
import {
...
} from "./state/combatRuntimeUi.js?v=681";
import {
  BATTLE_SPRITE_MOTION_IDS,
  clearBattleSpriteMotions,
  triggerBattleSpriteMotion,
} from "./ui/battleSpriteMotion.js?v=681";
import {
  monsterAttackEffectPlacement,
  monsterAttackEffectType,
  resolveMonsterBattleSpritePreset,
} from "./config/monsterBattleSpritePresets.js?v=681";
import { resolveMonsterRuntimeAction } from "./config/monsterRuntimeIntegrationPresets.js?v=681";
import { resolvePlayerAttackEffectPlacement } from "./config/playerBattleSprites.js?v=681";
...
import { buyShopItem, sellInventoryItem } from "./state/shop.js?v=681";
import { applyStanceSelection } from "./state/stance.js?v=681";
import {
  allocatePlayerStat,
  ...
  resetAllocatedStats,
} from "./state/statAllocation.js?v=681";
import { applyRegionSelection, previewRegionState } from "./state/regionSelection.js?v=681";
import {
  advanceRegionMonsterEncounter,
  regionMonsterEncounterSeed,
  resolveRegionMonster,
} from "./state/regionMonsterPool.js?v=681";
import {
  stepObjectiveRotationState,
  toggleObjectiveAlertState,
  toggleObjectiveRotationModeState,
} from "./state/objectiveUiState.js?v=681";
import {
...
} from "./story/dialogueEventRuntime.js?v=681";
import { claimOfflineAutoHuntReward, stampLastSeen } from "./state/offlineReward.js?v=681";
import { nodeName } from "./ui/renderRegion.js?v=681";
import { renderLog } from "./ui/renderCommon.js?v=681";
import { renderCombatSkillInfo } from "./ui/renderCombatActions.js?v=681";
import { renderHitCounter } from "./ui/renderCombatPulse.js?v=681";
import { playFateCardRevealMotion } from "./ui/fateCardRevealMotion.js?v=681";
import { setupCollapsiblePanels } from "./ui/panels.js?v=681";
import { setSaveStatus } from "./ui/saveSlotStatus.js?v=681";
import {
  activeViewId,
  activateView,
  resetCharacterCreationWizard,
  setCreationCancelMode,
} from "./ui/viewNavigation.js?v=681";
...
function combatActionRenderContext() {
  return createCombatActionRenderContext({
    state,
    combatRuntime,
    helpText: HELP_TEXT,
