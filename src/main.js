import {
  ...
  HELP_TEXT,
} from "./config/helpText.js?v=333";
import { bindAppEvents } from "./app/appEvents.js?v=333";
import { renderAppFrame, renderAppRegionList } from "./app/appRenderer.js?v=333";
import { handleObjectiveActionNavigation } from "./app/objectiveActionNavigation.js?v=333";
import {
  ACTIVE_SLOT_SYNC_INTERVAL_MS,
  MAX_LOG_LINES,
  OBJECTIVE_TICKER_INTERVAL_MS,
  SLOW_RENDER_INTERVAL_MS,
} from "./app/appRuntimeConfig.js?v=333";
import { finalizeSaveSessionTransition } from "./app/saveSessionFlow.js?v=333";
import { registerServiceWorker } from "./app/serviceWorkerRegistration.js";
import * as assetRegistryApi from "./assets/assetRegistry.js?v=333";
import { applyDomLocalization } from "./localization/domText.js?v=333";
import { t, tf } from "./localization/index.js?v=333";
import { clearCombatEffectLayers } from "./combat/combatEffects.js?v=333";
import { BULK_STAT_DEALLOCATE_AMOUNT } from "./balance/playerGrowthBalance.js?v=333";
import { CONTENT_PROFILE, applyContentProfileToDocument, exposeContentProfile } from "./content/contentProfile.js?v=333";
import {
  clamp,
...
import {
  ...
  stanceName,
} from "./combat/combatActions.js?v=333";
import {
  attackEffectType,
...
import { queueCombatTextEffect } from "./combat/combatFeedbackState.js?v=333";
import { resolveEnemyAttack, resolvePlayerAttack } from "./combat/combatDamage.js";
import { createDefeatedTargetPreview } from "./combat/combatDefeatPreview.js?v=333";
import {
  applyHealAction,
  applyResolvedEnemyAttack,
  applyResolvedPlayerAttack,
} from "./combat/combatActionResults.js?v=333";
import {
  advanceHitCombo,
  applySkillBreakDamage,
  playerHyperChargeFromSuccessfulHit,
  resetHitComboState,
} from "./combat/combatHitResults.js?v=333";
import {
  ...
  createCombatRuntime,
  resetCombatRuntime,
} from "./combat/combatState.js?v=333";
import {
  bossBreakMessage,
  combatStartMessage,
  combatStopMessage,
...
} from "./combat/combatTick.js?v=333";
import { clearIntervalTimer, clearTimeoutTimer, restartIntervalTimer, restartTimeoutTimer } from "./combat/combatTimers.js?v=333";
import {
  applyIncomingDamageTestOption,
  applyOutgoingDamageTestOption,
} from "./combat/combatTestOptions.js?v=333";
import {
  displayNames,
  equipment,
  gateMaps,
...
} from "./state/save.js?v=333";
import {
  developerOptionLabel,
  normalizeDeveloperOptionValue,
  normalizeDeveloperOptions,
} from "./state/developerOptions.js?v=333";
import { createInitialState } from "./state/initialState.js?v=333";
import { applyImportedUiState, exportSavePayloadSnapshot, importSavePayloadText } from "./state/saveLoadActions.js?v=333";
import { playerStats } from "./state/progression.js?v=333";
import { addInventoryItem } from "./state/inventory.js";
import { equipInventoryItem, resolveEquipmentSlot, unequipEquipmentSlot } from "./state/equipmentActions.js?v=333";
import { equipRecommendedItems } from "./state/recommendedEquipment.js?v=333";
import {
  beginGateReplay,
  ensureGateProgress as ensureGateProgressState,
  isGateProgressComplete,
  moveGateProgress,
} from "./state/regionProgress.js?v=333";
import {
  applyCharacterProfile,
  applyInitialCreationStats,
  createCharacterProfile,
  updatePlayerProfileSettings,
} from "./state/profileActions.js?v=333";
import {
  ...
  saveCurrentToSlot,
  saveSlotLabel,
} from "./state/saveSlots.js?v=333";
import {
  createPendingSlotCreationSnapshot,
  restorePendingSlotCreationSnapshot,
} from "./state/saveSlotSession.js?v=333";

import { createGateNodeResolution, resolveGateNodeOutcome } from "./state/gateNodeActions.js?v=333";
import {
  ...
  stopCombatSession,
  toggleAutoHuntState,
} from "./state/combatSession.js?v=333";
import {
...
} from "./state/passiveRecovery.js?v=333";
import { applyMonsterDefeatRewards } from "./state/combatRewards.js?v=333";
import { applyPendingLevelProgression } from "./state/levelUpActions.js?v=333";
...
} from "./state/hyperActions.js?v=333";
import {
...
} from "./state/combatRuntimeUi.js?v=333";
...
import { buyShopItem, sellInventoryItem } from "./state/shop.js?v=333";
import { applyStanceSelection } from "./state/stance.js?v=333";
import {
  allocatePlayerStat,
  ...
  resetAllocatedStats,
} from "./state/statAllocation.js?v=333";
import { applyRegionSelection, previewRegionState } from "./state/regionSelection.js?v=333";
import {
  stepObjectiveRotationState,
  toggleObjectiveAlertState,
  toggleObjectiveRotationModeState,
} from "./state/objectiveUiState.js?v=333";
import {
  ...
  shouldResetHitCombo,
} from "./state/playerResources.js?v=333";
import {
  hasSkillLoadout,
  resolveActiveLoadoutActions,
  resolveActiveLoadoutSkills,
  resolveActiveSkillLoadout,
} from "./state/skillLoadout.js?v=333";
import { claimOfflineAutoHuntReward, stampLastSeen } from "./state/offlineReward.js?v=333";
import { nodeName } from "./ui/renderRegion.js?v=333";
import { renderLog } from "./ui/renderCommon.js?v=333";
import { renderCombatSkillInfo } from "./ui/renderCombatActions.js?v=333";
import { renderHitCounter } from "./ui/renderCombatPulse.js?v=333";
import { setupCollapsiblePanels } from "./ui/panels.js?v=333";
import { setSaveStatus } from "./ui/saveSlotStatus.js?v=333";
import {
  activeViewId,
  activateView,
  resetCharacterCreationWizard,
  setCreationCancelMode,
} from "./ui/viewNavigation.js?v=333";
