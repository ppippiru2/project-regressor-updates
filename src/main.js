import {
  ...
  HELP_TEXT,
} from "./config/helpText.js?v=356";
import { bindAppEvents } from "./app/appEvents.js?v=356";
import { renderAppFrame, renderAppRegionList } from "./app/appRenderer.js?v=356";
import { handleObjectiveActionNavigation } from "./app/objectiveActionNavigation.js?v=356";
import {
  ACTIVE_SLOT_SYNC_INTERVAL_MS,
  MAX_LOG_LINES,
  OBJECTIVE_TICKER_INTERVAL_MS,
  SLOW_RENDER_INTERVAL_MS,
} from "./app/appRuntimeConfig.js?v=356";
import { finalizeSaveSessionTransition } from "./app/saveSessionFlow.js?v=356";
import { registerServiceWorker } from "./app/serviceWorkerRegistration.js";
import * as assetRegistryApi from "./assets/assetRegistry.js?v=356";
import { applyDomLocalization } from "./localization/domText.js?v=356";
import { t, tf } from "./localization/index.js?v=356";
import { clearCombatEffectLayers } from "./combat/combatEffects.js?v=356";
import { BULK_STAT_DEALLOCATE_AMOUNT } from "./balance/playerGrowthBalance.js?v=356";
import { CONTENT_PROFILE, applyContentProfileToDocument, exposeContentProfile } from "./content/contentProfile.js?v=356";
import {
  clamp,
...
import {
  ...
  stanceName,
} from "./combat/combatActions.js?v=356";
import {
  attackEffectType,
...
import { queueCombatTextEffect } from "./combat/combatFeedbackState.js?v=356";
import { resolveEnemyAttack, resolvePlayerAttack } from "./combat/combatDamage.js";
import { createDefeatedTargetPreview } from "./combat/combatDefeatPreview.js?v=356";
import {
  applyHealAction,
  applyResolvedEnemyAttack,
  applyResolvedPlayerAttack,
} from "./combat/combatActionResults.js?v=356";
import {
  advanceHitCombo,
  applySkillBreakDamage,
  playerHyperChargeFromSuccessfulHit,
  resetHitComboState,
} from "./combat/combatHitResults.js?v=356";
import {
  ...
  createCombatRuntime,
  resetCombatRuntime,
} from "./combat/combatState.js?v=356";
import {
  bossBreakMessage,
  combatStartMessage,
  combatStopMessage,
...
} from "./combat/combatTick.js?v=356";
import { clearIntervalTimer, clearTimeoutTimer, restartIntervalTimer, restartTimeoutTimer } from "./combat/combatTimers.js?v=356";
import {
  applyIncomingDamageTestOption,
  applyOutgoingDamageTestOption,
} from "./combat/combatTestOptions.js?v=356";
import {
  displayNames,
  equipment,
  gateMaps,
...
} from "./state/save.js?v=356";
import {
  developerOptionLabel,
  normalizeDeveloperOptionValue,
  normalizeDeveloperOptions,
} from "./state/developerOptions.js?v=356";
import { createInitialState } from "./state/initialState.js?v=356";
import { applyImportedUiState, exportSavePayloadSnapshot, importSavePayloadText } from "./state/saveLoadActions.js?v=356";
import { playerStats } from "./state/progression.js?v=356";
import { addInventoryItem } from "./state/inventory.js";
import { equipInventoryItem, resolveEquipmentSlot, unequipEquipmentSlot } from "./state/equipmentActions.js?v=356";
import { equipRecommendedItems } from "./state/recommendedEquipment.js?v=356";
import {
  beginGateReplay,
  ensureGateProgress as ensureGateProgressState,
  isGateProgressComplete,
  moveGateProgress,
} from "./state/regionProgress.js?v=356";
import {
  applyCharacterProfile,
  applyInitialCreationStats,
  createCharacterProfile,
  updatePlayerProfileSettings,
} from "./state/profileActions.js?v=356";
import {
  ...
  saveCurrentToSlot,
  saveSlotLabel,
} from "./state/saveSlots.js?v=356";
import {
  createPendingSlotCreationSnapshot,
  restorePendingSlotCreationSnapshot,
} from "./state/saveSlotSession.js?v=356";

import { createGateNodeResolution, resolveGateNodeOutcome } from "./state/gateNodeActions.js?v=356";
import {
  ...
  stopCombatSession,
  toggleAutoHuntState,
} from "./state/combatSession.js?v=356";
import {
...
} from "./state/passiveRecovery.js?v=356";
import { applyMonsterDefeatRewards } from "./state/combatRewards.js?v=356";
import { applyPendingLevelProgression } from "./state/levelUpActions.js?v=356";
...
} from "./state/hyperActions.js?v=356";
import {
...
} from "./state/combatRuntimeUi.js?v=356";
...
import { buyShopItem, sellInventoryItem } from "./state/shop.js?v=356";
import { applyStanceSelection } from "./state/stance.js?v=356";
import {
  allocatePlayerStat,
  ...
  resetAllocatedStats,
} from "./state/statAllocation.js?v=356";
import { applyRegionSelection, previewRegionState } from "./state/regionSelection.js?v=356";
import {
  stepObjectiveRotationState,
  toggleObjectiveAlertState,
  toggleObjectiveRotationModeState,
} from "./state/objectiveUiState.js?v=356";
import {
  ...
  shouldResetHitCombo,
} from "./state/playerResources.js?v=356";
import {
  hasSkillLoadout,
  resolveActiveLoadoutActions,
  resolveActiveLoadoutSkills,
  resolveActiveSkillLoadout,
} from "./state/skillLoadout.js?v=356";
import { claimOfflineAutoHuntReward, stampLastSeen } from "./state/offlineReward.js?v=356";
import { nodeName } from "./ui/renderRegion.js?v=356";
import { renderLog } from "./ui/renderCommon.js?v=356";
import { renderCombatSkillInfo } from "./ui/renderCombatActions.js?v=356";
import { renderHitCounter } from "./ui/renderCombatPulse.js?v=356";
import { setupCollapsiblePanels } from "./ui/panels.js?v=356";
import { setSaveStatus } from "./ui/saveSlotStatus.js?v=356";
import {
  activeViewId,
  activateView,
  resetCharacterCreationWizard,
  setCreationCancelMode,
} from "./ui/viewNavigation.js?v=356";
