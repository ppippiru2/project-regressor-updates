import {
  ...
  HELP_TEXT,
} from "./config/helpText.js?v=511";
import { bindAppEvents } from "./app/appEvents.js?v=511";
import { renderAppFrame, renderAppRegionList } from "./app/appRenderer.js?v=511";
import { handleObjectiveActionNavigation } from "./app/objectiveActionNavigation.js?v=511";
import {
  ACTIVE_SLOT_SYNC_INTERVAL_MS,
  MAX_LOG_LINES,
  OBJECTIVE_TICKER_INTERVAL_MS,
  SLOW_RENDER_INTERVAL_MS,
} from "./app/appRuntimeConfig.js?v=511";
import { finalizeSaveSessionTransition } from "./app/saveSessionFlow.js?v=511";
import { registerServiceWorker } from "./app/serviceWorkerRegistration.js";
import * as assetRegistryApi from "./assets/assetRegistry.js?v=511";
import { applyDomLocalization } from "./localization/domText.js?v=511";
import { t, tf } from "./localization/index.js?v=511";
import { clearCombatEffectLayers } from "./combat/combatEffects.js?v=511";
import { BULK_STAT_DEALLOCATE_AMOUNT } from "./balance/playerGrowthBalance.js?v=511";
import { CONTENT_PROFILE, applyContentProfileToDocument, exposeContentProfile } from "./content/contentProfile.js?v=511";
import {
  clamp,
...
import {
  ...
  stanceName,
} from "./combat/combatActions.js?v=511";
import {
  attackEffectType,
...
import { queueCombatTextEffect } from "./combat/combatFeedbackState.js?v=511";
import { resolveEnemyAttack, resolvePlayerAttack } from "./combat/combatDamage.js";
import { createDefeatedTargetPreview } from "./combat/combatDefeatPreview.js?v=511";
import {
  applyHealAction,
  applyResolvedEnemyAttack,
  applyResolvedPlayerAttack,
} from "./combat/combatActionResults.js?v=511";
import {
  ...
  resetHitComboState,
} from "./combat/combatHitResults.js?v=511";
import {
  ...
  createCombatRuntime,
  resetCombatRuntime,
} from "./combat/combatState.js?v=511";
import {
  bossBreakMessage,
  combatStartMessage,
  combatStopMessage,
...
} from "./combat/combatTick.js?v=511";
import { clearIntervalTimer, clearTimeoutTimer, restartIntervalTimer, restartTimeoutTimer } from "./combat/combatTimers.js?v=511";
import {
  applyIncomingDamageTestOption,
  applyOutgoingDamageTestOption,
} from "./combat/combatTestOptions.js?v=511";
import {
  displayNames,
  equipment,
  gateMaps,
...
} from "./state/save.js?v=511";
import {
  developerOptionLabel,
  normalizeDeveloperOptionValue,
  normalizeDeveloperOptions,
} from "./state/developerOptions.js?v=511";
import { createInitialState } from "./state/initialState.js?v=511";
import { applyImportedUiState, exportSavePayloadSnapshot, importSavePayloadText } from "./state/saveLoadActions.js?v=511";
import { playerStats } from "./state/progression.js?v=511";
import { starterTraitStatBonuses } from "./state/starterTraitEffects.js?v=511";
import { addInventoryItem } from "./state/inventory.js";
import { equipInventoryItem, resolveEquipmentSlot, unequipEquipmentSlot } from "./state/equipmentActions.js?v=511";
import { equipRecommendedItems } from "./state/recommendedEquipment.js?v=511";
import {
  beginGateReplay,
  ensureGateProgress as ensureGateProgressState,
  isGateProgressComplete,
  moveGateProgress,
} from "./state/regionProgress.js?v=511";
import {
...
} from "./state/profileActions.js?v=511";
import {
  ...
  saveCurrentToSlot,
  saveSlotLabel,
} from "./state/saveSlots.js?v=511";
import {
  createPendingSlotCreationSnapshot,
  restorePendingSlotCreationSnapshot,
} from "./state/saveSlotSession.js?v=511";

import { createGateNodeResolution, resolveGateNodeOutcome } from "./state/gateNodeActions.js?v=511";
import {
  ...
  stopCombatSession,
  toggleAutoHuntState,
} from "./state/combatSession.js?v=511";
import {
...
} from "./state/passiveRecovery.js?v=511";
import { applyMonsterDefeatRewards } from "./state/combatRewards.js?v=511";
import { applyPendingLevelProgression } from "./state/levelUpActions.js?v=511";
...
} from "./state/hyperActions.js?v=511";
import {
...
} from "./state/combatRuntimeUi.js?v=511";
import {
  BATTLE_SPRITE_MOTION_IDS,
  clearBattleSpriteMotions,
  triggerBattleSpriteMotion,
} from "./ui/battleSpriteMotion.js?v=511";
import {
  monsterAttackEffectPlacement,
  monsterAttackEffectType,
  resolveMonsterBattleSpritePreset,
} from "./config/monsterBattleSpritePresets.js?v=511";
import { resolveMonsterRuntimeAction } from "./config/monsterRuntimeIntegrationPresets.js?v=511";
import { resolvePlayerAttackEffectPlacement } from "./config/playerBattleSprites.js?v=511";
...
import { buyShopItem, sellInventoryItem } from "./state/shop.js?v=511";
import { applyStanceSelection } from "./state/stance.js?v=511";
import {
  allocatePlayerStat,
  ...
  resetAllocatedStats,
} from "./state/statAllocation.js?v=511";
import { applyRegionSelection, previewRegionState } from "./state/regionSelection.js?v=511";
import {
  advanceRegionMonsterEncounter,
  regionMonsterEncounterSeed,
  resolveRegionMonster,
} from "./state/regionMonsterPool.js?v=511";
import {
  stepObjectiveRotationState,
  toggleObjectiveAlertState,
  toggleObjectiveRotationModeState,
} from "./state/objectiveUiState.js?v=511";
import {
  ...
  shouldResetHitCombo,
} from "./state/playerResources.js?v=511";
import {
  hasSkillLoadout,
  resolveActiveLoadoutActions,
  resolveActiveLoadoutSkills,
  resolveActiveSkillLoadout,
} from "./state/skillLoadout.js?v=511";
import {
  claimFirstCombatGuide,
  claimRegionCoreEventGuide,
  createTutorialFlags,
} from "./state/tutorialGuidance.js?v=511";
import { claimOfflineAutoHuntReward, stampLastSeen } from "./state/offlineReward.js?v=511";
import { nodeName } from "./ui/renderRegion.js?v=511";
import { renderLog } from "./ui/renderCommon.js?v=511";
import { renderCombatSkillInfo } from "./ui/renderCombatActions.js?v=511";
import { renderHitCounter } from "./ui/renderCombatPulse.js?v=511";
import { setupCollapsiblePanels } from "./ui/panels.js?v=511";
import { setSaveStatus } from "./ui/saveSlotStatus.js?v=511";
import {
  activeViewId,
  activateView,
  resetCharacterCreationWizard,
  setCreationCancelMode,
} from "./ui/viewNavigation.js?v=511";
